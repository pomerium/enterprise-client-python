...
_SIMPLEMETRIC = DESCRIPTOR.message_types_by_name['SimpleMetric']
_SIMPLEMETRIC_TYPE = _SIMPLEMETRIC.enum_types_by_name['Type']
SimpleMetric = _reflection.GeneratedProtocolMessageType('SimpleMetric', (_message.Message,), {
  'DESCRIPTOR' : _SIMPLEMETRIC,
  '__module__' : 'envoy.admin.v3.metrics_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SIMPLEMETRIC._serialized_start=115
  _SIMPLEMETRIC._serialized_end=280
  _SIMPLEMETRIC_TYPE._serialized_start=209
  _SIMPLEMETRIC_TYPE._serialized_end=239
