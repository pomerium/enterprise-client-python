...
_STRINGMATCHER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='exact', full_name='envoy.type.matcher.v3.StringMatcher.exact', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='prefix', full_name='envoy.type.matcher.v3.StringMatcher.prefix', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='suffix', full_name='envoy.type.matcher.v3.StringMatcher.suffix', index=2,
      ...
      serialized_options=b'\372B\004r\002\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='safe_regex', full_name='envoy.type.matcher.v3.StringMatcher.safe_regex', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='contains', full_name='envoy.type.matcher.v3.StringMatcher.contains', index=4,
      ...
      serialized_options=b'\372B\004r\002\020\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ignore_case', full_name='envoy.type.matcher.v3.StringMatcher.ignore_case', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='match_pattern', full_name='envoy.type.matcher.v3.StringMatcher.match_pattern',
...
_LISTSTRINGMATCHER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='patterns', full_name='envoy.type.matcher.v3.ListStringMatcher.patterns', index=0,
...
_STRINGMATCHER.fields_by_name['safe_regex'].message_type = envoy_dot_type_dot_matcher_dot_v3_dot_regex__pb2._REGEXMATCHER
...
StringMatcher = _reflection.GeneratedProtocolMessageType('StringMatcher', (_message.Message,), {
  ...
  '__module__' : 'envoy.type.matcher.v3.string_pb2'
