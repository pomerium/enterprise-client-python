...
_FILTERSTATEMATCHER = DESCRIPTOR.message_types_by_name['FilterStateMatcher']
FilterStateMatcher = _reflection.GeneratedProtocolMessageType('FilterStateMatcher', (_message.Message,), {
  'DESCRIPTOR' : _FILTERSTATEMATCHER,
  '__module__' : 'envoy.type.matcher.v3.filter_state_pb2'
  # @@protoc_insertion_point(class_scope:envoy.type.matcher.v3.FilterStateMatcher)
  })
_sym_db.RegisterMessage(FilterStateMatcher)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FILTERSTATEMATCHER._serialized_start=159
  _FILTERSTATEMATCHER._serialized_end=279
