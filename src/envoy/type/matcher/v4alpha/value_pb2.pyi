...
"""
import builtins
import envoy.type.matcher.v4alpha.number_pb2
...
class ValueMatcher(google.protobuf.message.Message):
    ...
    def null_match(self) -> global___ValueMatcher.NullMatch:
        ...
        pass
    @property
    def double_match(self) -> envoy.type.matcher.v4alpha.number_pb2.DoubleMatcher:
    ...
    def __init__(self,
        *,
        ...
        double_match : typing.Optional[envoy.type.matcher.v4alpha.number_pb2.DoubleMatcher] = ...,
