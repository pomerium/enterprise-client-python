...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/type/matcher/v4alpha/struct.proto',
  package='envoy.type.matcher.v4alpha',
  syntax='proto3',
  serialized_options=b'\n(io.envoyproxy.envoy.type.matcher.v4alphaB\013StructProtoP\001\272\200\310\321\006\002\020\003',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\'envoy/type/matcher/v4alpha/struct.proto\x12\x1a\x65nvoy.type.matcher.v4alpha\x1a&envoy/type/matcher/v4alpha/value.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xbc\x02\n\rStructMatcher\x12M\n\x04path\x18\x02 \x03(\x0b\x32\x35.envoy.type.matcher.v4alpha.StructMatcher.PathSegmentB\x08\xfa\x42\x05\x92\x01\x02\x08\x01\x12\x41\n\x05value\x18\x03 \x01(\x0b\x32(.envoy.type.matcher.v4alpha.ValueMatcherB\x08\xfa\x42\x05\x8a\x01\x02\x10\x01\x1am\n\x0bPathSegment\x12\x16\n\x03key\x18\x01 \x01(\tB\x07\xfa\x42\x04r\x02\x10\x01H\x00:6\x9a\xc5\x88\x1e\x31\n/envoy.type.matcher.v3.StructMatcher.PathSegmentB\x0e\n\x07segment\x12\x03\xf8\x42\x01:*\x9a\xc5\x88\x1e%\n#envoy.type.matcher.v3.StructMatcherBA\n(io.envoyproxy.envoy.type.matcher.v4alphaB\x0bStructProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03\x62\x06proto3'
  ,
...
_STRUCTMATCHER_PATHSEGMENT = _descriptor.Descriptor(
  name='PathSegment',
  full_name='envoy.type.matcher.v4alpha.StructMatcher.PathSegment',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='envoy.type.matcher.v4alpha.StructMatcher.PathSegment.key', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='segment', full_name='envoy.type.matcher.v4alpha.StructMatcher.PathSegment.segment',
...
_STRUCTMATCHER = _descriptor.Descriptor(
  name='StructMatcher',
  full_name='envoy.type.matcher.v4alpha.StructMatcher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='path', full_name='envoy.type.matcher.v4alpha.StructMatcher.path', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='envoy.type.matcher.v4alpha.StructMatcher.value', index=1,
...
_STRUCTMATCHER.fields_by_name['value'].message_type = envoy_dot_type_dot_matcher_dot_v4alpha_dot_value__pb2._VALUEMATCHER
...
StructMatcher = _reflection.GeneratedProtocolMessageType('StructMatcher', (_message.Message,), {
  ...
  'PathSegment' : _reflection.GeneratedProtocolMessageType('PathSegment', (_message.Message,), {
    ...
    '__module__' : 'envoy.type.matcher.v4alpha.struct_pb2'
    # @@protoc_insertion_point(class_scope:envoy.type.matcher.v4alpha.StructMatcher.PathSegment)
    })
  ,
  'DESCRIPTOR' : _STRUCTMATCHER,
  '__module__' : 'envoy.type.matcher.v4alpha.struct_pb2'
  # @@protoc_insertion_point(class_scope:envoy.type.matcher.v4alpha.StructMatcher)
  })
