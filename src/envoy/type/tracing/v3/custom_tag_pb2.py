...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/type/tracing/v3/custom_tag.proto',
...
_CUSTOMTAG_LITERAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='envoy.type.tracing.v3.CustomTag.Literal.value', index=0,
...
_CUSTOMTAG_ENVIRONMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.type.tracing.v3.CustomTag.Environment.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMTAG_HEADER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.type.tracing.v3.CustomTag.Header.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMTAG_METADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='kind', full_name='envoy.type.tracing.v3.CustomTag.Metadata.kind', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata_key', full_name='envoy.type.tracing.v3.CustomTag.Metadata.metadata_key', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='default_value', full_name='envoy.type.tracing.v3.CustomTag.Metadata.default_value', index=2,
...
_CUSTOMTAG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tag', full_name='envoy.type.tracing.v3.CustomTag.tag', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='environment', full_name='envoy.type.tracing.v3.CustomTag.environment', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='request_header', full_name='envoy.type.tracing.v3.CustomTag.request_header', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='envoy.type.tracing.v3.CustomTag.metadata', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='type', full_name='envoy.type.tracing.v3.CustomTag.type',
...
_CUSTOMTAG_METADATA.fields_by_name['kind'].message_type = envoy_dot_type_dot_metadata_dot_v3_dot_metadata__pb2._METADATAKIND
_CUSTOMTAG_METADATA.fields_by_name['metadata_key'].message_type = envoy_dot_type_dot_metadata_dot_v3_dot_metadata__pb2._METADATAKEY
...
CustomTag = _reflection.GeneratedProtocolMessageType('CustomTag', (_message.Message,), {
  ...
  'Literal' : _reflection.GeneratedProtocolMessageType('Literal', (_message.Message,), {
    ...
    '__module__' : 'envoy.type.tracing.v3.custom_tag_pb2'
