...
_RATELIMITSTRATEGY = DESCRIPTOR.message_types_by_name['RateLimitStrategy']
_RATELIMITSTRATEGY_REQUESTSPERTIMEUNIT = _RATELIMITSTRATEGY.nested_types_by_name['RequestsPerTimeUnit']
_RATELIMITSTRATEGY_BLANKETRULE = _RATELIMITSTRATEGY.enum_types_by_name['BlanketRule']
RateLimitStrategy = _reflection.GeneratedProtocolMessageType('RateLimitStrategy', (_message.Message,), {

  'RequestsPerTimeUnit' : _reflection.GeneratedProtocolMessageType('RequestsPerTimeUnit', (_message.Message,), {
    'DESCRIPTOR' : _RATELIMITSTRATEGY_REQUESTSPERTIMEUNIT,
    '__module__' : 'envoy.type.v3.ratelimit_strategy_pb2'
    # @@protoc_insertion_point(class_scope:envoy.type.v3.RateLimitStrategy.RequestsPerTimeUnit)
    })
  ,
  'DESCRIPTOR' : _RATELIMITSTRATEGY,
  '__module__' : 'envoy.type.v3.ratelimit_strategy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.type.v3.RateLimitStrategy)
  })
_sym_db.RegisterMessage(RateLimitStrategy)
_sym_db.RegisterMessage(RateLimitStrategy.RequestsPerTimeUnit)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RATELIMITSTRATEGY._serialized_start=217
  _RATELIMITSTRATEGY._serialized_end=631
  _RATELIMITSTRATEGY_REQUESTSPERTIMEUNIT._serialized_start=458
  _RATELIMITSTRATEGY_REQUESTSPERTIMEUNIT._serialized_end=570
  _RATELIMITSTRATEGY_BLANKETRULE._serialized_start=572
  _RATELIMITSTRATEGY_BLANKETRULE._serialized_end=614
