...
_RATELIMITSERVICECONFIG = DESCRIPTOR.message_types_by_name['RateLimitServiceConfig']
RateLimitServiceConfig = _reflection.GeneratedProtocolMessageType('RateLimitServiceConfig', (_message.Message,), {
  ...
  '__module__' : 'envoy.config.ratelimit.v3.rls_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RATELIMITSERVICECONFIG._serialized_start=241
  _RATELIMITSERVICECONFIG._serialized_end=476
