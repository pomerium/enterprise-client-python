...
_TRACESERVICECONFIG = DESCRIPTOR.message_types_by_name['TraceServiceConfig']
TraceServiceConfig = _reflection.GeneratedProtocolMessageType('TraceServiceConfig', (_message.Message,), {
  ...
  '__module__' : 'envoy.config.trace.v3.service_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TRACESERVICECONFIG._serialized_start=195
  _TRACESERVICECONFIG._serialized_end=331
