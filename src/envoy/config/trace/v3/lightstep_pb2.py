...
_LIGHTSTEPCONFIG = DESCRIPTOR.message_types_by_name['LightstepConfig']
_LIGHTSTEPCONFIG_PROPAGATIONMODE = _LIGHTSTEPCONFIG.enum_types_by_name['PropagationMode']
LightstepConfig = _reflection.GeneratedProtocolMessageType('LightstepConfig', (_message.Message,), {
  'DESCRIPTOR' : _LIGHTSTEPCONFIG,
  '__module__' : 'envoy.config.trace.v3.lightstep_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _LIGHTSTEPCONFIG._serialized_start=258
  _LIGHTSTEPCONFIG._serialized_end=623
  _LIGHTSTEPCONFIG_PROPAGATIONMODE._serialized_start=507
  _LIGHTSTEPCONFIG_PROPAGATIONMODE._serialized_end=577
