...
ClusterConfig = _reflection.GeneratedProtocolMessageType('ClusterConfig', (_message.Message,), {
  ...
  '__module__' : 'envoy.config.cluster.aggregate.v2alpha.cluster_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.cluster.aggregate.v2alpha.ClusterConfig)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CLUSTERCONFIG._serialized_start=184
  _CLUSTERCONFIG._serialized_end=227
