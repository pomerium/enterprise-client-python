...
_REDISCLUSTERCONFIG = DESCRIPTOR.message_types_by_name['RedisClusterConfig']
RedisClusterConfig = _reflection.GeneratedProtocolMessageType('RedisClusterConfig', (_message.Message,), {
  ...
  '__module__' : 'envoy.config.cluster.redis.redis_cluster_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _REDISCLUSTERCONFIG._serialized_start=199
  _REDISCLUSTERCONFIG._serialized_end=560
