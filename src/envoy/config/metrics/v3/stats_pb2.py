...
_STATSSINK = DESCRIPTOR.message_types_by_name['StatsSink']
_STATSCONFIG = DESCRIPTOR.message_types_by_name['StatsConfig']
_STATSMATCHER = DESCRIPTOR.message_types_by_name['StatsMatcher']
_TAGSPECIFIER = DESCRIPTOR.message_types_by_name['TagSpecifier']
_HISTOGRAMBUCKETSETTINGS = DESCRIPTOR.message_types_by_name['HistogramBucketSettings']
_STATSDSINK = DESCRIPTOR.message_types_by_name['StatsdSink']
_DOGSTATSDSINK = DESCRIPTOR.message_types_by_name['DogStatsdSink']
_HYSTRIXSINK = DESCRIPTOR.message_types_by_name['HystrixSink']
StatsSink = _reflection.GeneratedProtocolMessageType('StatsSink', (_message.Message,), {
  'DESCRIPTOR' : _STATSSINK,
  '__module__' : 'envoy.config.metrics.v3.stats_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.metrics.v3.StatsSink)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _STATSSINK._serialized_start=287
  _STATSSINK._serialized_end=429
  _STATSCONFIG._serialized_start=432
  _STATSCONFIG._serialized_end=753
  _STATSMATCHER._serialized_start=756
  _STATSMATCHER._serialized_end=995
  _TAGSPECIFIER._serialized_start=998
  _TAGSPECIFIER._serialized_end=1138
  _HISTOGRAMBUCKETSETTINGS._serialized_start=1141
  _HISTOGRAMBUCKETSETTINGS._serialized_end=1271
  _STATSDSINK._serialized_start=1274
  _STATSDSINK._serialized_end=1448
  _DOGSTATSDSINK._serialized_start=1451
  _DOGSTATSDSINK._serialized_end=1684
  _HYSTRIXSINK._serialized_start=1686
  _HYSTRIXSINK._serialized_end=1764
