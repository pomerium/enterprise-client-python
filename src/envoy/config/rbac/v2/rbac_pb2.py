...
_RBAC = DESCRIPTOR.message_types_by_name['RBAC']
_RBAC_POLICIESENTRY = _RBAC.nested_types_by_name['PoliciesEntry']
_POLICY = DESCRIPTOR.message_types_by_name['Policy']
_PERMISSION = DESCRIPTOR.message_types_by_name['Permission']
_PERMISSION_SET = _PERMISSION.nested_types_by_name['Set']
_PRINCIPAL = DESCRIPTOR.message_types_by_name['Principal']
_PRINCIPAL_SET = _PRINCIPAL.nested_types_by_name['Set']
_PRINCIPAL_AUTHENTICATED = _PRINCIPAL.nested_types_by_name['Authenticated']
_RBAC_ACTION = _RBAC.enum_types_by_name['Action']
RBAC = _reflection.GeneratedProtocolMessageType('RBAC', (_message.Message,), {
  ...
  'PoliciesEntry' : _reflection.GeneratedProtocolMessageType('PoliciesEntry', (_message.Message,), {
    ...
    '__module__' : 'envoy.config.rbac.v2.rbac_pb2'
    # @@protoc_insertion_point(class_scope:envoy.config.rbac.v2.RBAC.PoliciesEntry)
    })
  ,
  'DESCRIPTOR' : _RBAC,
  '__module__' : 'envoy.config.rbac.v2.rbac_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RBAC._serialized_start=328
  _RBAC._serialized_end=555
  _RBAC_POLICIESENTRY._serialized_start=447
  _RBAC_POLICIESENTRY._serialized_end=524
  _RBAC_ACTION._serialized_start=526
  _RBAC_ACTION._serialized_end=555
  _POLICY._serialized_start=558
  _POLICY._serialized_end=745
  _PERMISSION._serialized_start=748
  _PERMISSION._serialized_end=1360
  _PERMISSION_SET._serialized_start=1283
  _PERMISSION_SET._serialized_end=1347
  _PRINCIPAL._serialized_start=1363
  _PRINCIPAL._serialized_end=2123
  _PRINCIPAL_SET._serialized_start=1961
  _PRINCIPAL_SET._serialized_end=2022
  _PRINCIPAL_AUTHENTICATED._serialized_start=2024
  _PRINCIPAL_AUTHENTICATED._serialized_end=2104
