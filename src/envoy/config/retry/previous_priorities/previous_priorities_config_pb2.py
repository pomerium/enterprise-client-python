...
_PREVIOUSPRIORITIESCONFIG = DESCRIPTOR.message_types_by_name['PreviousPrioritiesConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PREVIOUSPRIORITIESCONFIG._serialized_start=203
  _PREVIOUSPRIORITIESCONFIG._serialized_end=264
