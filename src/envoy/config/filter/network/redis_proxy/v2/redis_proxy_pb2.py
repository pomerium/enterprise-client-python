  ...
  'PrefixRoutes' : _reflection.GeneratedProtocolMessageType('PrefixRoutes', (_message.Message,), {
    ...
    'Route' : _reflection.GeneratedProtocolMessageType('Route', (_message.Message,), {
      ...
      'RequestMirrorPolicy' : _reflection.GeneratedProtocolMessageType('RequestMirrorPolicy', (_message.Message,), {
        ...
        '__module__' : 'envoy.config.filter.network.redis_proxy.v2.redis_proxy_pb2'
        # @@protoc_insertion_point(class_scope:envoy.config.filter.network.redis_proxy.v2.RedisProxy.PrefixRoutes.Route.RequestMirrorPolicy)
        })
      ,
      'DESCRIPTOR' : _REDISPROXY_PREFIXROUTES_ROUTE,
      '__module__' : 'envoy.config.filter.network.redis_proxy.v2.redis_proxy_pb2'
      # @@protoc_insertion_point(class_scope:envoy.config.filter.network.redis_proxy.v2.RedisProxy.PrefixRoutes.Route)
      })
    ,
    'DESCRIPTOR' : _REDISPROXY_PREFIXROUTES,
    '__module__' : 'envoy.config.filter.network.redis_proxy.v2.redis_proxy_pb2'
    # @@protoc_insertion_point(class_scope:envoy.config.filter.network.redis_proxy.v2.RedisProxy.PrefixRoutes)
    })
  ,
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _REDISPROXY._serialized_start=362
  _REDISPROXY._serialized_end=1881
  _REDISPROXY_CONNPOOLSETTINGS._serialized_start=727
  _REDISPROXY_CONNPOOLSETTINGS._serialized_end=1257
  _REDISPROXY_CONNPOOLSETTINGS_READPOLICY._serialized_start=1172
  _REDISPROXY_CONNPOOLSETTINGS_READPOLICY._serialized_end=1257
  _REDISPROXY_PREFIXROUTES._serialized_start=1260
  _REDISPROXY_PREFIXROUTES._serialized_end=1881
  _REDISPROXY_PREFIXROUTES_ROUTE._serialized_start=1531
  _REDISPROXY_PREFIXROUTES_ROUTE._serialized_end=1881
  _REDISPROXY_PREFIXROUTES_ROUTE_REQUESTMIRRORPOLICY._serialized_start=1732
  _REDISPROXY_PREFIXROUTES_ROUTE_REQUESTMIRRORPOLICY._serialized_end=1881
  _REDISPROTOCOLOPTIONS._serialized_start=1883
  _REDISPROTOCOLOPTIONS._serialized_end=1967
