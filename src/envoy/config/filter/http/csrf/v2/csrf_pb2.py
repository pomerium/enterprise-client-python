...
_CSRFPOLICY = DESCRIPTOR.message_types_by_name['CsrfPolicy']
CsrfPolicy = _reflection.GeneratedProtocolMessageType('CsrfPolicy', (_message.Message,), {
  'DESCRIPTOR' : _CSRFPOLICY,
  '__module__' : 'envoy.config.filter.http.csrf.v2.csrf_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.filter.http.csrf.v2.CsrfPolicy)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CSRFPOLICY._serialized_start=233
  _CSRFPOLICY._serialized_end=456
