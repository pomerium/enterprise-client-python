...
Cors = _reflection.GeneratedProtocolMessageType('Cors', (_message.Message,), {
  'DESCRIPTOR' : _CORS,
  '__module__' : 'envoy.config.filter.http.cors.v2.cors_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.filter.http.cors.v2.Cors)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CORS._serialized_start=144
  _CORS._serialized_end=150
