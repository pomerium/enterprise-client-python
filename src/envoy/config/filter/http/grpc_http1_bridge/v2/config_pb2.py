...
Config = _reflection.GeneratedProtocolMessageType('Config', (_message.Message,), {
  'DESCRIPTOR' : _CONFIG,
  '__module__' : 'envoy.config.filter.http.grpc_http1_bridge.v2.config_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.filter.http.grpc_http1_bridge.v2.Config)
  })
