...
FaultAbort = _reflection.GeneratedProtocolMessageType('FaultAbort', (_message.Message,), {
  ...
  'HeaderAbort' : _reflection.GeneratedProtocolMessageType('HeaderAbort', (_message.Message,), {
    ...
    # @@protoc_insertion_point(class_scope:envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort)
    })
  ,
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FAULTABORT._serialized_start=316
  _FAULTABORT._serialized_end=538
  _FAULTABORT_HEADERABORT._serialized_start=500
  _FAULTABORT_HEADERABORT._serialized_end=513
  _HTTPFAULT._serialized_start=541
  _HTTPFAULT._serialized_end=1116
