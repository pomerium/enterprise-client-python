...
OriginalSrc = _reflection.GeneratedProtocolMessageType('OriginalSrc', (_message.Message,), {
  ...
  '__module__' : 'envoy.config.filter.http.original_src.v2alpha1.original_src_pb2'
  # @@protoc_insertion_point(class_scope:envoy.config.filter.http.original_src.v2alpha1.OriginalSrc)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ORIGINALSRC._serialized_start=180
  _ORIGINALSRC._serialized_end=207
