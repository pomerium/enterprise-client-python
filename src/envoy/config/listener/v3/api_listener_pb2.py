...
_APILISTENER = DESCRIPTOR.message_types_by_name['ApiListener']
ApiListener = _reflection.GeneratedProtocolMessageType('ApiListener', (_message.Message,), {
  'DESCRIPTOR' : _APILISTENER,
  '__module__' : 'envoy.config.listener.v3.api_listener_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _APILISTENER._serialized_start=166
  _APILISTENER._serialized_end=268
