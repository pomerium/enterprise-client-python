...
_KEYVALUESTORECONFIG = DESCRIPTOR.message_types_by_name['KeyValueStoreConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _KEYVALUESTORECONFIG._serialized_start=210
  _KEYVALUESTORECONFIG._serialized_end=311
