...
_SUBSTITUTIONFORMATSTRING = DESCRIPTOR.message_types_by_name['SubstitutionFormatString']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SUBSTITUTIONFORMATSTRING._serialized_start=274
  _SUBSTITUTIONFORMATSTRING._serialized_end=599
