...
_EVENTSERVICECONFIG = DESCRIPTOR.message_types_by_name['EventServiceConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EVENTSERVICECONFIG._serialized_start=206
  _EVENTSERVICECONFIG._serialized_end=362
