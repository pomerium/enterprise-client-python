...
_HEALTHCHECK_HTTPHEALTHCHECK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='retriable_statuses', full_name='envoy.config.core.v3.HealthCheck.HttpHealthCheck.retriable_statuses', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='codec_client_type', full_name='envoy.config.core.v3.HealthCheck.HttpHealthCheck.codec_client_type', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='service_name_matcher', full_name='envoy.config.core.v3.HealthCheck.HttpHealthCheck.service_name_matcher', index=9,
...
_HEALTHCHECK_HTTPHEALTHCHECK.fields_by_name['retriable_statuses'].message_type = envoy_dot_type_dot_v3_dot_range__pb2._INT64RANGE
