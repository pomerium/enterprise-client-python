...
import envoy.config.route.v4alpha.route_components_pb2
...
class RouteConfiguration(google.protobuf.message.Message):
    ...
    * HTTP :ref:`router filter <config_http_filters_router>`
    ...
    @property
    def virtual_hosts(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[envoy.config.route.v4alpha.route_components_pb2.VirtualHost]:
    ...
    * connection manager level
    ...
    def __init__(self,
        *,
        name : typing.Text = ...,
        virtual_hosts : typing.Optional[typing.Iterable[envoy.config.route.v4alpha.route_components_pb2.VirtualHost]] = ...,
...
class Vhds(google.protobuf.message.Message):
    ...
    @property
    def config_source(self) -> envoy.config.core.v4alpha.config_source_pb2.ConfigSource:
        """Configuration source specifier for VHDS."""
        pass
    def __init__(self,
        *,
        config_source : typing.Optional[envoy.config.core.v4alpha.config_source_pb2.ConfigSource] = ...,
        ) -> None: ...
