...
import envoy.config.core.v4alpha.extension_pb2
import envoy.config.core.v4alpha.proxy_protocol_pb2
import envoy.type.matcher.v4alpha.regex_pb2
import envoy.type.matcher.v4alpha.string_pb2
...
class VirtualHost(google.protobuf.message.Message):
    ...
    * HTTP :ref:`router filter <config_http_filters_router>`
    ...
    def rate_limits(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RateLimit]:
        ...
        pass
    @property
    def request_headers_to_add(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[envoy.config.core.v4alpha.base_pb2.HeaderValueOption]:
    ...
    def request_headers_to_remove(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[typing.Text]:
        ...
        pass
    @property
    def response_headers_to_add(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[envoy.config.core.v4alpha.base_pb2.HeaderValueOption]:
    ...
    def __init__(self,
        *,
        ...
        request_headers_to_add : typing.Optional[typing.Iterable[envoy.config.core.v4alpha.base_pb2.HeaderValueOption]] = ...,
        request_headers_to_remove : typing.Optional[typing.Iterable[typing.Text]] = ...,
        response_headers_to_add : typing.Optional[typing.Iterable[envoy.config.core.v4alpha.base_pb2.HeaderValueOption]] = ...,
...
class WeightedCluster(google.protobuf.message.Message):
    ...
    class ClusterWeight(google.protobuf.message.Message):
        ...
        def weight(self) -> google.protobuf.wrappers_pb2.UInt32Value:
            ...
            pass
        @property
        def metadata_match(self) -> envoy.config.core.v4alpha.base_pb2.Metadata:
        ...
        def __init__(self,
            *,
            ...
            metadata_match : typing.Optional[envoy.config.core.v4alpha.base_pb2.Metadata] = ...,
            request_headers_to_add : typing.Optional[typing.Iterable[envoy.config.core.v4alpha.base_pb2.HeaderValueOption]] = ...,
            request_headers_to_remove : typing.Optional[typing.Iterable[typing.Text]] = ...,
            response_headers_to_add : typing.Optional[typing.Iterable[envoy.config.core.v4alpha.base_pb2.HeaderValueOption]] = ...,
            response_headers_to_remove : typing.Optional[typing.Iterable[typing.Text]] = ...,
...
class RouteMatch(google.protobuf.message.Message):
    ...
    def case_sensitive(self) -> google.protobuf.wrappers_pb2.BoolValue:
        ...
        pass
    @property
    def runtime_fraction(self) -> envoy.config.core.v4alpha.base_pb2.RuntimeFractionalPercent:
    ...
    def __init__(self,
        *,
        ...
        runtime_fraction : typing.Optional[envoy.config.core.v4alpha.base_pb2.RuntimeFractionalPercent] = ...,
...
class CorsPolicy(google.protobuf.message.Message):
    ...
    @property
    def allow_origin_string_match(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[envoy.type.matcher.v4alpha.string_pb2.StringMatcher]:
    ...
    def allow_credentials(self) -> google.protobuf.wrappers_pb2.BoolValue:
        ...
        pass
    @property
    def filter_enabled(self) -> envoy.config.core.v4alpha.base_pb2.RuntimeFractionalPercent:
        ...
        pass
    @property
    def shadow_enabled(self) -> envoy.config.core.v4alpha.base_pb2.RuntimeFractionalPercent:
    ...
    def __init__(self,
        *,
        allow_origin_string_match : typing.Optional[typing.Iterable[envoy.type.matcher.v4alpha.string_pb2.StringMatcher]] = ...,
        allow_methods : typing.Text = ...,
        allow_headers : typing.Text = ...,
        expose_headers : typing.Text = ...,
        max_age : typing.Text = ...,
        allow_credentials : typing.Optional[google.protobuf.wrappers_pb2.BoolValue] = ...,
        filter_enabled : typing.Optional[envoy.config.core.v4alpha.base_pb2.RuntimeFractionalPercent] = ...,
        shadow_enabled : typing.Optional[envoy.config.core.v4alpha.base_pb2.RuntimeFractionalPercent] = ...,
        ) -> None: ...
...
class RouteAction(google.protobuf.message.Message):
    ...
    class HashPolicy(google.protobuf.message.Message):
        ...
        class Header(google.protobuf.message.Message):
            ...
            @property
            def regex_rewrite(self) -> envoy.type.matcher.v4alpha.regex_pb2.RegexMatchAndSubstitute:
            ...
            def __init__(self,
                *,
                header_name : typing.Text = ...,
                regex_rewrite : typing.Optional[envoy.type.matcher.v4alpha.regex_pb2.RegexMatchAndSubstitute] = ...,
                ) -> None: ...
    ...
    class UpgradeConfig(google.protobuf.message.Message):
        ...
        class ConnectConfig(google.protobuf.message.Message):
            ...
            @property
            def proxy_protocol_config(self) -> envoy.config.core.v4alpha.proxy_protocol_pb2.ProxyProtocolConfig:
            ...
            def __init__(self,
                *,
                proxy_protocol_config : typing.Optional[envoy.config.core.v4alpha.proxy_protocol_pb2.ProxyProtocolConfig] = ...,
                allow_post : builtins.bool = ...,
                ) -> None: ...
    ...
    @property
    def host_rewrite_path_regex(self) -> envoy.type.matcher.v4alpha.regex_pb2.RegexMatchAndSubstitute:
        """Indicates that during forwarding, the host header will be swapped with
    ...
    def request_mirror_policies(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RouteAction.RequestMirrorPolicy]:
        ...
        pass
    priority: envoy.config.core.v4alpha.base_pb2.RoutingPriority.V = ...
    ...
    def __init__(self,
        *,
        ...
        host_rewrite_header : typing.Text = ...,
        host_rewrite_path_regex : typing.Optional[envoy.type.matcher.v4alpha.regex_pb2.RegexMatchAndSubstitute] = ...,
...
class RetryPolicy(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"max_retries",b"max_retries",u"per_try_timeout",b"per_try_timeout",u"rate_limited_retry_back_off",b"rate_limited_retry_back_off",u"retry_back_off",b"retry_back_off",u"retry_priority",b"retry_priority"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"host_selection_retry_max_attempts",b"host_selection_retry_max_attempts",u"max_retries",b"max_retries",u"per_try_timeout",b"per_try_timeout",u"rate_limited_retry_back_off",b"rate_limited_retry_back_off",u"retriable_headers",b"retriable_headers",u"retriable_request_headers",b"retriable_request_headers",u"retriable_status_codes",b"retriable_status_codes",u"retry_back_off",b"retry_back_off",u"retry_host_predicate",b"retry_host_predicate",u"retry_on",b"retry_on",u"retry_priority",b"retry_priority"]) -> None: ...
...
class DirectResponseAction(google.protobuf.message.Message):
    ...
    @property
    def body(self) -> envoy.config.core.v4alpha.base_pb2.DataSource:
    ...
    def __init__(self,
        *,
        status : builtins.int = ...,
        body : typing.Optional[envoy.config.core.v4alpha.base_pb2.DataSource] = ...,
        ) -> None: ...
...
class RateLimit(google.protobuf.message.Message):
    ...
    class Action(google.protobuf.message.Message):
        ...
        def metadata(self) -> global___RateLimit.Action.MetaData:
            ...
            pass
        @property
        def extension(self) -> envoy.config.core.v4alpha.extension_pb2.TypedExtensionConfig:
        ...
        def __init__(self,
            *,
            ...
            extension : typing.Optional[envoy.config.core.v4alpha.extension_pb2.TypedExtensionConfig] = ...,
            ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal[u"action_specifier",b"action_specifier",u"destination_cluster",b"destination_cluster",u"extension",b"extension",u"generic_key",b"generic_key",u"header_value_match",b"header_value_match",u"metadata",b"metadata",u"remote_address",b"remote_address",u"request_headers",b"request_headers",u"source_cluster",b"source_cluster"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal[u"action_specifier",b"action_specifier",u"destination_cluster",b"destination_cluster",u"extension",b"extension",u"generic_key",b"generic_key",u"header_value_match",b"header_value_match",u"metadata",b"metadata",u"remote_address",b"remote_address",u"request_headers",b"request_headers",u"source_cluster",b"source_cluster"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal[u"action_specifier",b"action_specifier"]) -> typing.Optional[typing_extensions.Literal["source_cluster","destination_cluster","request_headers","remote_address","generic_key","header_value_match","metadata","extension"]]: ...
...
class HeaderMatcher(google.protobuf.message.Message):
    ...
    @property
    def string_match(self) -> envoy.type.matcher.v4alpha.string_pb2.StringMatcher:
    ...
    * The range [-10,0) will match the value -1, so it will not match when inverted.
    ...
    def __init__(self,
        *,
        ...
        present_match : builtins.bool = ...,
        string_match : typing.Optional[envoy.type.matcher.v4alpha.string_pb2.StringMatcher] = ...,
        invert_match : builtins.bool = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal[u"header_match_specifier",b"header_match_specifier",u"present_match",b"present_match",u"range_match",b"range_match",u"string_match",b"string_match"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"header_match_specifier",b"header_match_specifier",u"invert_match",b"invert_match",u"name",b"name",u"present_match",b"present_match",u"range_match",b"range_match",u"string_match",b"string_match"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"header_match_specifier",b"header_match_specifier"]) -> typing.Optional[typing_extensions.Literal["range_match","present_match","string_match"]]: ...
...
class InternalRedirectPolicy(google.protobuf.message.Message):
    ...
    def redirect_response_codes(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        ...
        pass
    @property
    def predicates(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[envoy.config.core.v4alpha.extension_pb2.TypedExtensionConfig]:
    ...
    def __init__(self,
        *,
        ...
        predicates : typing.Optional[typing.Iterable[envoy.config.core.v4alpha.extension_pb2.TypedExtensionConfig]] = ...,
        allow_cross_scheme_redirect : builtins.bool = ...,
        ) -> None: ...
