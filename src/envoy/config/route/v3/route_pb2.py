...
_ROUTECONFIGURATION_TYPEDPERFILTERCONFIGENTRY = _ROUTECONFIGURATION.nested_types_by_name['TypedPerFilterConfigEntry']
...
RouteConfiguration = _reflection.GeneratedProtocolMessageType('RouteConfiguration', (_message.Message,), {
  ...
  'TypedPerFilterConfigEntry' : _reflection.GeneratedProtocolMessageType('TypedPerFilterConfigEntry', (_message.Message,), {
    'DESCRIPTOR' : _ROUTECONFIGURATION_TYPEDPERFILTERCONFIGENTRY,
    '__module__' : 'envoy.config.route.v3.route_pb2'
    # @@protoc_insertion_point(class_scope:envoy.config.route.v3.RouteConfiguration.TypedPerFilterConfigEntry)
    })
  ,
...
_sym_db.RegisterMessage(RouteConfiguration.TypedPerFilterConfigEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ROUTECONFIGURATION._serialized_start=332
  _ROUTECONFIGURATION._serialized_end=1451
  _ROUTECONFIGURATION_TYPEDPERFILTERCONFIGENTRY._serialized_start=1330
  _ROUTECONFIGURATION_TYPEDPERFILTERCONFIGENTRY._serialized_end=1411
  _VHDS._serialized_start=1453
  _VHDS._serialized_end=1554
