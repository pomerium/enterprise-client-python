...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/config/route/v3/route.proto',
...
_ROUTECONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='envoy.config.route.v3.RouteConfiguration.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='virtual_hosts', full_name='envoy.config.route.v3.RouteConfiguration.virtual_hosts', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='vhds', full_name='envoy.config.route.v3.RouteConfiguration.vhds', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='internal_only_headers', full_name='envoy.config.route.v3.RouteConfiguration.internal_only_headers', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_headers_to_add', full_name='envoy.config.route.v3.RouteConfiguration.response_headers_to_add', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='response_headers_to_remove', full_name='envoy.config.route.v3.RouteConfiguration.response_headers_to_remove', index=5,
      ...
      serialized_options=b'\372B\r\222\001\n\"\010r\006\300\001\001\310\001\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='request_headers_to_add', full_name='envoy.config.route.v3.RouteConfiguration.request_headers_to_add', index=6,
      ...
      serialized_options=b'\372B\006\222\001\003\020\350\007', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='request_headers_to_remove', full_name='envoy.config.route.v3.RouteConfiguration.request_headers_to_remove', index=7,
      ...
      serialized_options=b'\372B\r\222\001\n\"\010r\006\300\001\001\310\001\000', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='most_specific_header_mutations_wins', full_name='envoy.config.route.v3.RouteConfiguration.most_specific_header_mutations_wins', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validate_clusters', full_name='envoy.config.route.v3.RouteConfiguration.validate_clusters', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_direct_response_body_size_bytes', full_name='envoy.config.route.v3.RouteConfiguration.max_direct_response_body_size_bytes', index=10,
...
_VHDS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='config_source', full_name='envoy.config.route.v3.Vhds.config_source', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  serialized_options=b'\232\305\210\036\023\n\021envoy.api.v2.Vhds',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_ROUTECONFIGURATION.fields_by_name['response_headers_to_add'].message_type = envoy_dot_config_dot_core_dot_v3_dot_base__pb2._HEADERVALUEOPTION
