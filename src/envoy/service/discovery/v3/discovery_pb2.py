...
_RESOURCELOCATOR_DYNAMICPARAMETERSENTRY = _RESOURCELOCATOR.nested_types_by_name['DynamicParametersEntry']
...
_DISCOVERYRESPONSE = DESCRIPTOR.message_types_by_name['DiscoveryResponse']
_DELTADISCOVERYREQUEST = DESCRIPTOR.message_types_by_name['DeltaDiscoveryRequest']
_DELTADISCOVERYREQUEST_INITIALRESOURCEVERSIONSENTRY = _DELTADISCOVERYREQUEST.nested_types_by_name['InitialResourceVersionsEntry']
_DELTADISCOVERYRESPONSE = DESCRIPTOR.message_types_by_name['DeltaDiscoveryResponse']
_DYNAMICPARAMETERCONSTRAINTS = DESCRIPTOR.message_types_by_name['DynamicParameterConstraints']
_DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT = _DYNAMICPARAMETERCONSTRAINTS.nested_types_by_name['SingleConstraint']
_DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT_EXISTS = _DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT.nested_types_by_name['Exists']
_DYNAMICPARAMETERCONSTRAINTS_CONSTRAINTLIST = _DYNAMICPARAMETERCONSTRAINTS.nested_types_by_name['ConstraintList']
_RESOURCE = DESCRIPTOR.message_types_by_name['Resource']
_RESOURCE_CACHECONTROL = _RESOURCE.nested_types_by_name['CacheControl']
ResourceLocator = _reflection.GeneratedProtocolMessageType('ResourceLocator', (_message.Message,), {
  ...
  'DynamicParametersEntry' : _reflection.GeneratedProtocolMessageType('DynamicParametersEntry', (_message.Message,), {
    'DESCRIPTOR' : _RESOURCELOCATOR_DYNAMICPARAMETERSENTRY,
    '__module__' : 'envoy.service.discovery.v3.discovery_pb2'
    # @@protoc_insertion_point(class_scope:envoy.service.discovery.v3.ResourceLocator.DynamicParametersEntry)
    })
  ,
...
_sym_db.RegisterMessage(ResourceLocator.DynamicParametersEntry)
...
DynamicParameterConstraints = _reflection.GeneratedProtocolMessageType('DynamicParameterConstraints', (_message.Message,), {

  'SingleConstraint' : _reflection.GeneratedProtocolMessageType('SingleConstraint', (_message.Message,), {

    'Exists' : _reflection.GeneratedProtocolMessageType('Exists', (_message.Message,), {
      'DESCRIPTOR' : _DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT_EXISTS,
      '__module__' : 'envoy.service.discovery.v3.discovery_pb2'
      # @@protoc_insertion_point(class_scope:envoy.service.discovery.v3.DynamicParameterConstraints.SingleConstraint.Exists)
      })
    ,
    'DESCRIPTOR' : _DYNAMICPARAMETERCONSTRAINTS_SINGLECONSTRAINT,
    '__module__' : 'envoy.service.discovery.v3.discovery_pb2'
    # @@protoc_insertion_point(class_scope:envoy.service.discovery.v3.DynamicParameterConstraints.SingleConstraint)
    })
  ,

  'ConstraintList' : _reflection.GeneratedProtocolMessageType('ConstraintList', (_message.Message,), {
    'DESCRIPTOR' : _DYNAMICPARAMETERCONSTRAINTS_CONSTRAINTLIST,
    '__module__' : 'envoy.service.discovery.v3.discovery_pb2'
    # @@protoc_insertion_point(class_scope:envoy.service.discovery.v3.DynamicParameterConstraints.ConstraintList)
    })
  ,
  'DESCRIPTOR' : _DYNAMICPARAMETERCONSTRAINTS,
  '__module__' : 'envoy.service.discovery.v3.discovery_pb2'
  # @@protoc_insertion_point(class_scope:envoy.service.discovery.v3.DynamicParameterConstraints)
  })
_sym_db.RegisterMessage(DynamicParameterConstraints)
_sym_db.RegisterMessage(DynamicParameterConstraints.SingleConstraint)
_sym_db.RegisterMessage(DynamicParameterConstraints.SingleConstraint.Exists)
_sym_db.RegisterMessage(DynamicParameterConstraints.ConstraintList)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RESOURCE._serialized_end=3184
  _RESOURCE_CACHECONTROL._serialized_start=3118
  _RESOURCE_CACHECONTROL._serialized_end=3154
