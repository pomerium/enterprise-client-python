...
CircuitBreakers = _reflection.GeneratedProtocolMessageType('CircuitBreakers', (_message.Message,), {
  ...
  'Thresholds' : _reflection.GeneratedProtocolMessageType('Thresholds', (_message.Message,), {
    ...
    'RetryBudget' : _reflection.GeneratedProtocolMessageType('RetryBudget', (_message.Message,), {
      ...
      # @@protoc_insertion_point(class_scope:envoy.api.v2.cluster.CircuitBreakers.Thresholds.RetryBudget)
      })
    ,
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CIRCUITBREAKERS._serialized_start=245
  _CIRCUITBREAKERS._serialized_end=919
  _CIRCUITBREAKERS_THRESHOLDS._serialized_start=335
  _CIRCUITBREAKERS_THRESHOLDS._serialized_end=919
  _CIRCUITBREAKERS_THRESHOLDS_RETRYBUDGET._serialized_start=800
  _CIRCUITBREAKERS_THRESHOLDS_RETRYBUDGET._serialized_end=919
