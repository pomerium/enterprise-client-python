...
class ScopedRoutesDiscoveryService(object):
    ...
    * Routing :ref:`architecture overview <arch_overview_http_routing>`
    ...
    def StreamScopedRoutes(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/envoy.api.v2.ScopedRoutesDiscoveryService/StreamScopedRoutes',
    ...
    def DeltaScopedRoutes(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/envoy.api.v2.ScopedRoutesDiscoveryService/DeltaScopedRoutes',
    ...
    def FetchScopedRoutes(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/envoy.api.v2.ScopedRoutesDiscoveryService/FetchScopedRoutes',
            envoy_dot_api_dot_v2_dot_discovery__pb2.DiscoveryRequest.SerializeToString,
            envoy_dot_api_dot_v2_dot_discovery__pb2.DiscoveryResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
