...
_GRPCMETHODLIST = DESCRIPTOR.message_types_by_name['GrpcMethodList']
_GRPCMETHODLIST_SERVICE = _GRPCMETHODLIST.nested_types_by_name['Service']
GrpcMethodList = _reflection.GeneratedProtocolMessageType('GrpcMethodList', (_message.Message,), {
  ...
  'Service' : _reflection.GeneratedProtocolMessageType('Service', (_message.Message,), {
    ...
    '__module__' : 'envoy.api.v2.core.grpc_method_list_pb2'
    # @@protoc_insertion_point(class_scope:envoy.api.v2.core.GrpcMethodList.Service)
    })
  ,
  'DESCRIPTOR' : _GRPCMETHODLIST,
  '__module__' : 'envoy.api.v2.core.grpc_method_list_pb2'
  # @@protoc_insertion_point(class_scope:envoy.api.v2.core.GrpcMethodList)
  })
