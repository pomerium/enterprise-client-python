...
_UPSTREAMIPPORTMATCHER = DESCRIPTOR.message_types_by_name['UpstreamIpPortMatcher']
UpstreamIpPortMatcher = _reflection.GeneratedProtocolMessageType('UpstreamIpPortMatcher', (_message.Message,), {
  'DESCRIPTOR' : _UPSTREAMIPPORTMATCHER,
  '__module__' : 'envoy.extensions.rbac.matchers.upstream_ip_port.v3.upstream_ip_port_matcher_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.rbac.matchers.upstream_ip_port.v3.UpstreamIpPortMatcher)
  })
_sym_db.RegisterMessage(UpstreamIpPortMatcher)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _UPSTREAMIPPORTMATCHER._serialized_start=232
  _UPSTREAMIPPORTMATCHER._serialized_end=365
