...
_ZSTD = DESCRIPTOR.message_types_by_name['Zstd']
_ZSTD_STRATEGY = _ZSTD.enum_types_by_name['Strategy']
Zstd = _reflection.GeneratedProtocolMessageType('Zstd', (_message.Message,), {
  'DESCRIPTOR' : _ZSTD,
  '__module__' : 'envoy.extensions.compression.zstd.compressor.v3.zstd_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.compression.zstd.compressor.v3.Zstd)
  })
_sym_db.RegisterMessage(Zstd)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ZSTD._serialized_start=233
  _ZSTD._serialized_end=662
  _ZSTD_STRATEGY._serialized_start=534
  _ZSTD_STRATEGY._serialized_end=662
