...
_DEFAULTSOCKETINTERFACE = DESCRIPTOR.message_types_by_name['DefaultSocketInterface']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DEFAULTSOCKETINTERFACE._serialized_start=156
  _DEFAULTSOCKETINTERFACE._serialized_end=180
