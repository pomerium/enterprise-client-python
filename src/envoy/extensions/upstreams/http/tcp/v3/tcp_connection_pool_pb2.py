...
_TCPCONNECTIONPOOLPROTO = DESCRIPTOR.message_types_by_name['TcpConnectionPoolProto']
TcpConnectionPoolProto = _reflection.GeneratedProtocolMessageType('TcpConnectionPoolProto', (_message.Message,), {
  'DESCRIPTOR' : _TCPCONNECTIONPOOLPROTO,
  '__module__' : 'envoy.extensions.upstreams.http.tcp.v3.tcp_connection_pool_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.upstreams.http.tcp.v3.TcpConnectionPoolProto)
  })
_sym_db.RegisterMessage(TcpConnectionPoolProto)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TCPCONNECTIONPOOLPROTO._serialized_start=139
  _TCPCONNECTIONPOOLPROTO._serialized_end=163
