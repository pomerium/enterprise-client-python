...
_HTTPCONNECTIONPOOLPROTO = DESCRIPTOR.message_types_by_name['HttpConnectionPoolProto']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HTTPCONNECTIONPOOLPROTO._serialized_start=142
  _HTTPCONNECTIONPOOLPROTO._serialized_end=167
