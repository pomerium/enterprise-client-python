...
_PREVIOUSROUTESCONFIG = DESCRIPTOR.message_types_by_name['PreviousRoutesConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PREVIOUSROUTESCONFIG._serialized_start=172
  _PREVIOUSROUTESCONFIG._serialized_end=194
