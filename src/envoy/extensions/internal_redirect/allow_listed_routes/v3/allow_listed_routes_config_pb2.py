...
_ALLOWLISTEDROUTESCONFIG = DESCRIPTOR.message_types_by_name['AllowListedRoutesConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ALLOWLISTEDROUTESCONFIG._serialized_start=209
  _ALLOWLISTEDROUTESCONFIG._serialized_end=277
