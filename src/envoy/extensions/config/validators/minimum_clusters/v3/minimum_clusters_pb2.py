...
_MINIMUMCLUSTERSVALIDATOR = DESCRIPTOR.message_types_by_name['MinimumClustersValidator']
MinimumClustersValidator = _reflection.GeneratedProtocolMessageType('MinimumClustersValidator', (_message.Message,), {
  'DESCRIPTOR' : _MINIMUMCLUSTERSVALIDATOR,
  '__module__' : 'envoy.extensions.config.validators.minimum_clusters.v3.minimum_clusters_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.config.validators.minimum_clusters.v3.MinimumClustersValidator)
  })
_sym_db.RegisterMessage(MinimumClustersValidator)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MINIMUMCLUSTERSVALIDATOR._serialized_start=168
  _MINIMUMCLUSTERSVALIDATOR._serialized_end=220
