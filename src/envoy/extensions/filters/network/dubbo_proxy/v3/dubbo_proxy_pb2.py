...
_SERIALIZATIONTYPE = DESCRIPTOR.enum_types_by_name['SerializationType']
SerializationType = enum_type_wrapper.EnumTypeWrapper(_SERIALIZATIONTYPE)
Dubbo = 0
Hessian2 = 0


_DRDS = DESCRIPTOR.message_types_by_name['Drds']
_DUBBOPROXY = DESCRIPTOR.message_types_by_name['DubboProxy']
_DUBBOFILTER = DESCRIPTOR.message_types_by_name['DubboFilter']
Drds = _reflection.GeneratedProtocolMessageType('Drds', (_message.Message,), {
  'DESCRIPTOR' : _DRDS,
  '__module__' : 'envoy.extensions.filters.network.dubbo_proxy.v3.dubbo_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.dubbo_proxy.v3.Drds)
  })
_sym_db.RegisterMessage(Drds)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PROTOCOLTYPE._serialized_start=1387
  _PROTOCOLTYPE._serialized_end=1412
  _SERIALIZATIONTYPE._serialized_start=1414
  _SERIALIZATIONTYPE._serialized_end=1447
  _DRDS._serialized_start=408
  _DRDS._serialized_end=510
  _DUBBOPROXY._serialized_start=513
  _DUBBOPROXY._serialized_end=1239
  _DUBBOFILTER._serialized_start=1242
  _DUBBOFILTER._serialized_end=1385
