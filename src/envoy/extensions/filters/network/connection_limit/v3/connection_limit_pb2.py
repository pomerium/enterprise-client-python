...
_CONNECTIONLIMIT = DESCRIPTOR.message_types_by_name['ConnectionLimit']
ConnectionLimit = _reflection.GeneratedProtocolMessageType('ConnectionLimit', (_message.Message,), {
  'DESCRIPTOR' : _CONNECTIONLIMIT,
  '__module__' : 'envoy.extensions.filters.network.connection_limit.v3.connection_limit_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.connection_limit.v3.ConnectionLimit)
  })
_sym_db.RegisterMessage(ConnectionLimit)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CONNECTIONLIMIT._serialized_start=287
  _CONNECTIONLIMIT._serialized_end=507
