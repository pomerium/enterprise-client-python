...
_PAYLOADTOMETADATA = DESCRIPTOR.message_types_by_name['PayloadToMetadata']
_PAYLOADTOMETADATA_KEYVALUEPAIR = _PAYLOADTOMETADATA.nested_types_by_name['KeyValuePair']
_PAYLOADTOMETADATA_RULE = _PAYLOADTOMETADATA.nested_types_by_name['Rule']
_PAYLOADTOMETADATA_FIELDSELECTOR = _PAYLOADTOMETADATA.nested_types_by_name['FieldSelector']
_PAYLOADTOMETADATA_VALUETYPE = _PAYLOADTOMETADATA.enum_types_by_name['ValueType']
PayloadToMetadata = _reflection.GeneratedProtocolMessageType('PayloadToMetadata', (_message.Message,), {

  'KeyValuePair' : _reflection.GeneratedProtocolMessageType('KeyValuePair', (_message.Message,), {
    'DESCRIPTOR' : _PAYLOADTOMETADATA_KEYVALUEPAIR,
    '__module__' : 'envoy.extensions.filters.network.thrift_proxy.filters.payload_to_metadata.v3.payload_to_metadata_pb2'
  ...
  'Rule' : _reflection.GeneratedProtocolMessageType('Rule', (_message.Message,), {
    'DESCRIPTOR' : _PAYLOADTOMETADATA_RULE,
    '__module__' : 'envoy.extensions.filters.network.thrift_proxy.filters.payload_to_metadata.v3.payload_to_metadata_pb2'
  ...
  'FieldSelector' : _reflection.GeneratedProtocolMessageType('FieldSelector', (_message.Message,), {
    'DESCRIPTOR' : _PAYLOADTOMETADATA_FIELDSELECTOR,
    '__module__' : 'envoy.extensions.filters.network.thrift_proxy.filters.payload_to_metadata.v3.payload_to_metadata_pb2'
...
_sym_db.RegisterMessage(PayloadToMetadata)
_sym_db.RegisterMessage(PayloadToMetadata.KeyValuePair)
_sym_db.RegisterMessage(PayloadToMetadata.Rule)
_sym_db.RegisterMessage(PayloadToMetadata.FieldSelector)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PAYLOADTOMETADATA._serialized_start=276
  _PAYLOADTOMETADATA._serialized_end=1466
  _PAYLOADTOMETADATA_KEYVALUEPAIR._serialized_start=434
  _PAYLOADTOMETADATA_KEYVALUEPAIR._serialized_end=740
  _PAYLOADTOMETADATA_RULE._serialized_start=743
  _PAYLOADTOMETADATA_RULE._serialized_end=1228
  _PAYLOADTOMETADATA_FIELDSELECTOR._serialized_start=1231
  _PAYLOADTOMETADATA_FIELDSELECTOR._serialized_end=1429
  _PAYLOADTOMETADATA_VALUETYPE._serialized_start=1431
  _PAYLOADTOMETADATA_VALUETYPE._serialized_end=1466
