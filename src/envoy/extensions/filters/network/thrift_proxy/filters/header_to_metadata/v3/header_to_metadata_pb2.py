...
_HEADERTOMETADATA = DESCRIPTOR.message_types_by_name['HeaderToMetadata']
_HEADERTOMETADATA_KEYVALUEPAIR = _HEADERTOMETADATA.nested_types_by_name['KeyValuePair']
_HEADERTOMETADATA_RULE = _HEADERTOMETADATA.nested_types_by_name['Rule']
_HEADERTOMETADATA_VALUETYPE = _HEADERTOMETADATA.enum_types_by_name['ValueType']
_HEADERTOMETADATA_VALUEENCODE = _HEADERTOMETADATA.enum_types_by_name['ValueEncode']
HeaderToMetadata = _reflection.GeneratedProtocolMessageType('HeaderToMetadata', (_message.Message,), {

  'KeyValuePair' : _reflection.GeneratedProtocolMessageType('KeyValuePair', (_message.Message,), {
    'DESCRIPTOR' : _HEADERTOMETADATA_KEYVALUEPAIR,
    '__module__' : 'envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3.header_to_metadata_pb2'
  ...
  'Rule' : _reflection.GeneratedProtocolMessageType('Rule', (_message.Message,), {
    'DESCRIPTOR' : _HEADERTOMETADATA_RULE,
    '__module__' : 'envoy.extensions.filters.network.thrift_proxy.filters.header_to_metadata.v3.header_to_metadata_pb2'
...
_sym_db.RegisterMessage(HeaderToMetadata)
_sym_db.RegisterMessage(HeaderToMetadata.KeyValuePair)
_sym_db.RegisterMessage(HeaderToMetadata.Rule)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HEADERTOMETADATA._serialized_start=273
  _HEADERTOMETADATA._serialized_end=1260
  _HEADERTOMETADATA_KEYVALUEPAIR._serialized_start=428
  _HEADERTOMETADATA_KEYVALUEPAIR._serialized_end=854
  _HEADERTOMETADATA_RULE._serialized_start=857
  _HEADERTOMETADATA_RULE._serialized_end=1166
  _HEADERTOMETADATA_VALUETYPE._serialized_start=1168
  _HEADERTOMETADATA_VALUETYPE._serialized_end=1223
  _HEADERTOMETADATA_VALUEENCODE._serialized_start=1225
  _HEADERTOMETADATA_VALUEENCODE._serialized_end=1260
