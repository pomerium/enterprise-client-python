...
_GZIP = DESCRIPTOR.message_types_by_name['Gzip']
_GZIP_COMPRESSIONLEVEL = _GZIP.nested_types_by_name['CompressionLevel']
_GZIP_COMPRESSIONLEVEL_ENUM = _GZIP_COMPRESSIONLEVEL.enum_types_by_name['Enum']
_GZIP_COMPRESSIONSTRATEGY = _GZIP.enum_types_by_name['CompressionStrategy']
Gzip = _reflection.GeneratedProtocolMessageType('Gzip', (_message.Message,), {
  ...
  'CompressionLevel' : _reflection.GeneratedProtocolMessageType('CompressionLevel', (_message.Message,), {
    ...
    '__module__' : 'envoy.extensions.filters.http.gzip.v3.gzip_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GZIP._serialized_start=277
  _GZIP._serialized_end=1110
  _GZIP_COMPRESSIONLEVEL._serialized_start=760
  _GZIP_COMPRESSIONLEVEL._serialized_end=883
  _GZIP_COMPRESSIONLEVEL_ENUM._serialized_start=780
  _GZIP_COMPRESSIONLEVEL_ENUM._serialized_end=820
  _GZIP_COMPRESSIONSTRATEGY._serialized_start=885
  _GZIP_COMPRESSIONSTRATEGY._serialized_end=955
