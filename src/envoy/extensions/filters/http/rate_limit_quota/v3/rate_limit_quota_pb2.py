...
_RATELIMITQUOTAFILTERCONFIG = DESCRIPTOR.message_types_by_name['RateLimitQuotaFilterConfig']
_RATELIMITQUOTAOVERRIDE = DESCRIPTOR.message_types_by_name['RateLimitQuotaOverride']
_RATELIMITQUOTABUCKETSETTINGS = DESCRIPTOR.message_types_by_name['RateLimitQuotaBucketSettings']
_RATELIMITQUOTABUCKETSETTINGS_NOASSIGNMENTBEHAVIOR = _RATELIMITQUOTABUCKETSETTINGS.nested_types_by_name['NoAssignmentBehavior']
_RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR = _RATELIMITQUOTABUCKETSETTINGS.nested_types_by_name['ExpiredAssignmentBehavior']
_RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR_REUSELASTASSIGNMENT = _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR.nested_types_by_name['ReuseLastAssignment']
_RATELIMITQUOTABUCKETSETTINGS_DENYRESPONSESETTINGS = _RATELIMITQUOTABUCKETSETTINGS.nested_types_by_name['DenyResponseSettings']
_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER = _RATELIMITQUOTABUCKETSETTINGS.nested_types_by_name['BucketIdBuilder']
_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_VALUEBUILDER = _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER.nested_types_by_name['ValueBuilder']
_RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_BUCKETIDBUILDERENTRY = _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER.nested_types_by_name['BucketIdBuilderEntry']
RateLimitQuotaFilterConfig = _reflection.GeneratedProtocolMessageType('RateLimitQuotaFilterConfig', (_message.Message,), {
  'DESCRIPTOR' : _RATELIMITQUOTAFILTERCONFIG,
  '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaFilterConfig)
  })
_sym_db.RegisterMessage(RateLimitQuotaFilterConfig)

RateLimitQuotaOverride = _reflection.GeneratedProtocolMessageType('RateLimitQuotaOverride', (_message.Message,), {
  'DESCRIPTOR' : _RATELIMITQUOTAOVERRIDE,
  '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaOverride)
  })
_sym_db.RegisterMessage(RateLimitQuotaOverride)

RateLimitQuotaBucketSettings = _reflection.GeneratedProtocolMessageType('RateLimitQuotaBucketSettings', (_message.Message,), {

  'NoAssignmentBehavior' : _reflection.GeneratedProtocolMessageType('NoAssignmentBehavior', (_message.Message,), {
    'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_NOASSIGNMENTBEHAVIOR,
    '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  ...
  'ExpiredAssignmentBehavior' : _reflection.GeneratedProtocolMessageType('ExpiredAssignmentBehavior', (_message.Message,), {

    'ReuseLastAssignment' : _reflection.GeneratedProtocolMessageType('ReuseLastAssignment', (_message.Message,), {
      'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR_REUSELASTASSIGNMENT,
      '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
    ...
    ,
    'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR,
    '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  ...
  'DenyResponseSettings' : _reflection.GeneratedProtocolMessageType('DenyResponseSettings', (_message.Message,), {
    'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_DENYRESPONSESETTINGS,
    '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  ...
  'BucketIdBuilder' : _reflection.GeneratedProtocolMessageType('BucketIdBuilder', (_message.Message,), {

    'ValueBuilder' : _reflection.GeneratedProtocolMessageType('ValueBuilder', (_message.Message,), {
      'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_VALUEBUILDER,
      '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
    ...
    'BucketIdBuilderEntry' : _reflection.GeneratedProtocolMessageType('BucketIdBuilderEntry', (_message.Message,), {
      'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_BUCKETIDBUILDERENTRY,
      '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
      # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings.BucketIdBuilder.BucketIdBuilderEntry)
      })
    ,
    'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER,
    '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  ...
  ,
  'DESCRIPTOR' : _RATELIMITQUOTABUCKETSETTINGS,
  '__module__' : 'envoy.extensions.filters.http.rate_limit_quota.v3.rate_limit_quota_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.rate_limit_quota.v3.RateLimitQuotaBucketSettings)
  })
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.NoAssignmentBehavior)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.ExpiredAssignmentBehavior)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.ExpiredAssignmentBehavior.ReuseLastAssignment)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.DenyResponseSettings)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.BucketIdBuilder)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.BucketIdBuilder.ValueBuilder)
_sym_db.RegisterMessage(RateLimitQuotaBucketSettings.BucketIdBuilder.BucketIdBuilderEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RATELIMITQUOTAFILTERCONFIG._serialized_start=526
  _RATELIMITQUOTAFILTERCONFIG._serialized_end=956
  _RATELIMITQUOTAOVERRIDE._serialized_start=958
  _RATELIMITQUOTAOVERRIDE._serialized_end=1053
  _RATELIMITQUOTABUCKETSETTINGS._serialized_start=1056
  _RATELIMITQUOTABUCKETSETTINGS._serialized_end=2936
  _RATELIMITQUOTABUCKETSETTINGS_NOASSIGNMENTBEHAVIOR._serialized_start=1699
  _RATELIMITQUOTABUCKETSETTINGS_NOASSIGNMENTBEHAVIOR._serialized_end=1817
  _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR._serialized_start=1820
  _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR._serialized_end=2214
  _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR_REUSELASTASSIGNMENT._serialized_start=2157
  _RATELIMITQUOTABUCKETSETTINGS_EXPIREDASSIGNMENTBEHAVIOR_REUSELASTASSIGNMENT._serialized_end=2178
  _RATELIMITQUOTABUCKETSETTINGS_DENYRESPONSESETTINGS._serialized_start=2217
  _RATELIMITQUOTABUCKETSETTINGS_DENYRESPONSESETTINGS._serialized_end=2460
  _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER._serialized_start=2463
  _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER._serialized_end=2936
  _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_VALUEBUILDER._serialized_start=2639
  _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_VALUEBUILDER._serialized_end=2769
  _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_BUCKETIDBUILDERENTRY._serialized_start=2772
  _RATELIMITQUOTABUCKETSETTINGS_BUCKETIDBUILDER_BUCKETIDBUILDERENTRY._serialized_end=2936
