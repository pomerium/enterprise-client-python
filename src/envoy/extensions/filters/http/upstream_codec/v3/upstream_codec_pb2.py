...
_UPSTREAMCODEC = DESCRIPTOR.message_types_by_name['UpstreamCodec']
UpstreamCodec = _reflection.GeneratedProtocolMessageType('UpstreamCodec', (_message.Message,), {
  'DESCRIPTOR' : _UPSTREAMCODEC,
  '__module__' : 'envoy.extensions.filters.http.upstream_codec.v3.upstream_codec_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.upstream_codec.v3.UpstreamCodec)
  })
_sym_db.RegisterMessage(UpstreamCodec)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _UPSTREAMCODEC._serialized_start=152
  _UPSTREAMCODEC._serialized_end=167
