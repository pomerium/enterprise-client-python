...
_ONDEMANDCDS = DESCRIPTOR.message_types_by_name['OnDemandCds']
_ONDEMAND = DESCRIPTOR.message_types_by_name['OnDemand']
_PERROUTECONFIG = DESCRIPTOR.message_types_by_name['PerRouteConfig']
OnDemandCds = _reflection.GeneratedProtocolMessageType('OnDemandCds', (_message.Message,), {
  'DESCRIPTOR' : _ONDEMANDCDS,
...
_sym_db.RegisterMessage(OnDemandCds)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ONDEMANDCDS._serialized_start=272
  _ONDEMANDCDS._serialized_end=418
  _ONDEMAND._serialized_start=421
  _ONDEMAND._serialized_end=558
  _PERROUTECONFIG._serialized_start=560
  _PERROUTECONFIG._serialized_end=648
