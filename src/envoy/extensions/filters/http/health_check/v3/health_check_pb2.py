...
_HEALTHCHECK_CLUSTERMINHEALTHYPERCENTAGESENTRY = _HEALTHCHECK.nested_types_by_name['ClusterMinHealthyPercentagesEntry']
HealthCheck = _reflection.GeneratedProtocolMessageType('HealthCheck', (_message.Message,), {
  ...
  'ClusterMinHealthyPercentagesEntry' : _reflection.GeneratedProtocolMessageType('ClusterMinHealthyPercentagesEntry', (_message.Message,), {
    ...
    '__module__' : 'envoy.extensions.filters.http.health_check.v3.health_check_pb2'
    # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.health_check.v3.HealthCheck.ClusterMinHealthyPercentagesEntry)
    })
  ,
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HEALTHCHECK._serialized_start=346
  _HEALTHCHECK._serialized_end=822
  _HEALTHCHECK_CLUSTERMINHEALTHYPERCENTAGESENTRY._serialized_start=664
  _HEALTHCHECK_CLUSTERMINHEALTHYPERCENTAGESENTRY._serialized_end=755
