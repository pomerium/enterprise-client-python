...
_DNSFILTERCONFIG = DESCRIPTOR.message_types_by_name['DnsFilterConfig']
_DNSFILTERCONFIG_SERVERCONTEXTCONFIG = _DNSFILTERCONFIG.nested_types_by_name['ServerContextConfig']
_DNSFILTERCONFIG_CLIENTCONTEXTCONFIG = _DNSFILTERCONFIG.nested_types_by_name['ClientContextConfig']
DnsFilterConfig = _reflection.GeneratedProtocolMessageType('DnsFilterConfig', (_message.Message,), {
  ...
  'ServerContextConfig' : _reflection.GeneratedProtocolMessageType('ServerContextConfig', (_message.Message,), {
    ...
    '__module__' : 'envoy.extensions.filters.udp.dns_filter.v3.dns_filter_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DNSFILTERCONFIG._serialized_start=412
  _DNSFILTERCONFIG._serialized_end=1199
  _DNSFILTERCONFIG_SERVERCONTEXTCONFIG._serialized_start=670
  _DNSFILTERCONFIG_SERVERCONTEXTCONFIG._serialized_end=834
  _DNSFILTERCONFIG_CLIENTCONTEXTCONFIG._serialized_start=837
  _DNSFILTERCONFIG_CLIENTCONTEXTCONFIG._serialized_end=1199
