...
_LEASTREQUEST = DESCRIPTOR.message_types_by_name['LeastRequest']
LeastRequest = _reflection.GeneratedProtocolMessageType('LeastRequest', (_message.Message,), {
  'DESCRIPTOR' : _LEASTREQUEST,
  '__module__' : 'envoy.extensions.load_balancing_policies.least_request.v3.least_request_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.load_balancing_policies.least_request.v3.LeastRequest)
  })
_sym_db.RegisterMessage(LeastRequest)
