...
_WRRLOCALITY = DESCRIPTOR.message_types_by_name['WrrLocality']
WrrLocality = _reflection.GeneratedProtocolMessageType('WrrLocality', (_message.Message,), {
  'DESCRIPTOR' : _WRRLOCALITY,
  '__module__' : 'envoy.extensions.load_balancing_policies.wrr_locality.v3.wrr_locality_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.load_balancing_policies.wrr_locality.v3.WrrLocality)
  })
_sym_db.RegisterMessage(WrrLocality)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _WRRLOCALITY._serialized_start=232
  _WRRLOCALITY._serialized_end=334
