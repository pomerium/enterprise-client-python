...
_INTERNALUPSTREAMTRANSPORT = DESCRIPTOR.message_types_by_name['InternalUpstreamTransport']
_INTERNALUPSTREAMTRANSPORT_METADATAVALUESOURCE = _INTERNALUPSTREAMTRANSPORT.nested_types_by_name['MetadataValueSource']
InternalUpstreamTransport = _reflection.GeneratedProtocolMessageType('InternalUpstreamTransport', (_message.Message,), {

  'MetadataValueSource' : _reflection.GeneratedProtocolMessageType('MetadataValueSource', (_message.Message,), {
    'DESCRIPTOR' : _INTERNALUPSTREAMTRANSPORT_METADATAVALUESOURCE,
    '__module__' : 'envoy.extensions.transport_sockets.internal_upstream.v3.internal_upstream_pb2'
  ...
  ,
  'DESCRIPTOR' : _INTERNALUPSTREAMTRANSPORT,
  '__module__' : 'envoy.extensions.transport_sockets.internal_upstream.v3.internal_upstream_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.transport_sockets.internal_upstream.v3.InternalUpstreamTransport)
  })
_sym_db.RegisterMessage(InternalUpstreamTransport)
_sym_db.RegisterMessage(InternalUpstreamTransport.MetadataValueSource)
