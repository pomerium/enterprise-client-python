...
_STARTTLSCONFIG = DESCRIPTOR.message_types_by_name['StartTlsConfig']
_UPSTREAMSTARTTLSCONFIG = DESCRIPTOR.message_types_by_name['UpstreamStartTlsConfig']
...
UpstreamStartTlsConfig = _reflection.GeneratedProtocolMessageType('UpstreamStartTlsConfig', (_message.Message,), {
  'DESCRIPTOR' : _UPSTREAMSTARTTLSCONFIG,
  '__module__' : 'envoy.extensions.transport_sockets.starttls.v3.starttls_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.transport_sockets.starttls.v3.UpstreamStartTlsConfig)
  })
_sym_db.RegisterMessage(UpstreamStartTlsConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _STARTTLSCONFIG._serialized_start=290
  _STARTTLSCONFIG._serialized_end=502
  _UPSTREAMSTARTTLSCONFIG._serialized_start=505
  _UPSTREAMSTARTTLSCONFIG._serialized_end=723
