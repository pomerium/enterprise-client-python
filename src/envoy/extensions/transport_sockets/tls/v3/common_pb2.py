...
_TLSPARAMETERS = DESCRIPTOR.message_types_by_name['TlsParameters']
...
_TLSSESSIONTICKETKEYS = DESCRIPTOR.message_types_by_name['TlsSessionTicketKeys']
_CERTIFICATEPROVIDERPLUGININSTANCE = DESCRIPTOR.message_types_by_name['CertificateProviderPluginInstance']
_SUBJECTALTNAMEMATCHER = DESCRIPTOR.message_types_by_name['SubjectAltNameMatcher']
_CERTIFICATEVALIDATIONCONTEXT = DESCRIPTOR.message_types_by_name['CertificateValidationContext']
_TLSPARAMETERS_TLSPROTOCOL = _TLSPARAMETERS.enum_types_by_name['TlsProtocol']
_SUBJECTALTNAMEMATCHER_SANTYPE = _SUBJECTALTNAMEMATCHER.enum_types_by_name['SanType']
_CERTIFICATEVALIDATIONCONTEXT_TRUSTCHAINVERIFICATION = _CERTIFICATEVALIDATIONCONTEXT.enum_types_by_name['TrustChainVerification']
...
CertificateProviderPluginInstance = _reflection.GeneratedProtocolMessageType('CertificateProviderPluginInstance', (_message.Message,), {
  'DESCRIPTOR' : _CERTIFICATEPROVIDERPLUGININSTANCE,
  '__module__' : 'envoy.extensions.transport_sockets.tls.v3.common_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.transport_sockets.tls.v3.CertificateProviderPluginInstance)
  })
_sym_db.RegisterMessage(CertificateProviderPluginInstance)

SubjectAltNameMatcher = _reflection.GeneratedProtocolMessageType('SubjectAltNameMatcher', (_message.Message,), {
  'DESCRIPTOR' : _SUBJECTALTNAMEMATCHER,
  '__module__' : 'envoy.extensions.transport_sockets.tls.v3.common_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.transport_sockets.tls.v3.SubjectAltNameMatcher)
  })
_sym_db.RegisterMessage(SubjectAltNameMatcher)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['ca_certificate_provider_instance']._serialized_options = b'\362\230\376\217\005\020\022\016ca_cert_source'
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['verify_certificate_spki']._options = None
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['verify_certificate_spki']._serialized_options = b'\372B\013\222\001\010\"\006r\004\020,(,'
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['verify_certificate_hash']._options = None
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['verify_certificate_hash']._serialized_options = b'\372B\013\222\001\010\"\006r\004\020@(_'
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['match_subject_alt_names']._options = None
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['match_subject_alt_names']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  ...
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['max_verify_depth']._options = None
  _CERTIFICATEVALIDATIONCONTEXT.fields_by_name['max_verify_depth']._serialized_options = b'\372B\004*\002\030d'
  _CERTIFICATEVALIDATIONCONTEXT._options = None
  _CERTIFICATEVALIDATIONCONTEXT._serialized_options = b'\232\305\210\0360\n.envoy.api.v2.auth.CertificateValidationContext'
  _TLSPARAMETERS._serialized_start=462
  _TLSPARAMETERS._serialized_end=878
  _TLSPARAMETERS_TLSPROTOCOL._serialized_start=759
  _TLSPARAMETERS_TLSPROTOCOL._serialized_end=838
  _PRIVATEKEYPROVIDER._serialized_start=881
  _PRIVATEKEYPROVIDER._serialized_end=1061
  _TLSCERTIFICATE._serialized_start=1064
  _TLSCERTIFICATE._serialized_end=1650
  _TLSSESSIONTICKETKEYS._serialized_start=1653
  _TLSSESSIONTICKETKEYS._serialized_end=1786
  _CERTIFICATEPROVIDERPLUGININSTANCE._serialized_start=1788
  _CERTIFICATEPROVIDERPLUGININSTANCE._serialized_end=1872
  _SUBJECTALTNAMEMATCHER._serialized_start=1875
  _SUBJECTALTNAMEMATCHER._serialized_end=2149
  _SUBJECTALTNAMEMATCHER_SANTYPE._serialized_start=2069
  _SUBJECTALTNAMEMATCHER_SANTYPE._serialized_end=2149
  _CERTIFICATEVALIDATIONCONTEXT._serialized_start=2152
  _CERTIFICATEVALIDATIONCONTEXT._serialized_end=3397
  _CERTIFICATEVALIDATIONCONTEXT_TRUSTCHAINVERIFICATION._serialized_start=3235
  _CERTIFICATEVALIDATIONCONTEXT_TRUSTCHAINVERIFICATION._serialized_end=3305
