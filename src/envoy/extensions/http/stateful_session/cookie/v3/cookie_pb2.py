...
_COOKIEBASEDSESSIONSTATE = DESCRIPTOR.message_types_by_name['CookieBasedSessionState']
CookieBasedSessionState = _reflection.GeneratedProtocolMessageType('CookieBasedSessionState', (_message.Message,), {
  'DESCRIPTOR' : _COOKIEBASEDSESSIONSTATE,
  '__module__' : 'envoy.extensions.http.stateful_session.cookie.v3.cookie_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.http.stateful_session.cookie.v3.CookieBasedSessionState)
  })
_sym_db.RegisterMessage(CookieBasedSessionState)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _COOKIEBASEDSESSIONSTATE._serialized_start=204
  _COOKIEBASEDSESSIONSTATE._serialized_end=283
