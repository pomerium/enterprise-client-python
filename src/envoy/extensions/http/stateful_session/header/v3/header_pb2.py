...
_HEADERBASEDSESSIONSTATE = DESCRIPTOR.message_types_by_name['HeaderBasedSessionState']
HeaderBasedSessionState = _reflection.GeneratedProtocolMessageType('HeaderBasedSessionState', (_message.Message,), {
  'DESCRIPTOR' : _HEADERBASEDSESSIONSTATE,
  '__module__' : 'envoy.extensions.http.stateful_session.header.v3.header_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.http.stateful_session.header.v3.HeaderBasedSessionState)
  })
_sym_db.RegisterMessage(HeaderBasedSessionState)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HEADERBASEDSESSIONSTATE._serialized_start=171
  _HEADERBASEDSESSIONSTATE._serialized_end=219
