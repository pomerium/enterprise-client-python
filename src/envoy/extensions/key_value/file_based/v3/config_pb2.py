...
_FILEBASEDKEYVALUESTORECONFIG = DESCRIPTOR.message_types_by_name['FileBasedKeyValueStoreConfig']
FileBasedKeyValueStoreConfig = _reflection.GeneratedProtocolMessageType('FileBasedKeyValueStoreConfig', (_message.Message,), {
  'DESCRIPTOR' : _FILEBASEDKEYVALUESTORECONFIG,
  '__module__' : 'envoy.extensions.key_value.file_based.v3.config_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.key_value.file_based.v3.FileBasedKeyValueStoreConfig)
  })
_sym_db.RegisterMessage(FileBasedKeyValueStoreConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _FILEBASEDKEYVALUESTORECONFIG._serialized_start=253
  _FILEBASEDKEYVALUESTORECONFIG._serialized_end=422
