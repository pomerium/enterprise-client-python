...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n?envoy/extensions/common/async_files/v3/async_file_manager.proto\x12&envoy.extensions.common.async_files.v3\x1a\x1fxds/annotations/v3/status.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xbf\x01\n\x16\x41syncFileManagerConfig\x12\n\n\x02id\x18\x01 \x01(\t\x12`\n\x0bthread_pool\x18\x02 \x01(\x0b\x32I.envoy.extensions.common.async_files.v3.AsyncFileManagerConfig.ThreadPoolH\x00\x1a\"\n\nThreadPool\x12\x14\n\x0cthread_count\x18\x01 \x01(\rB\x13\n\x0cmanager_type\x12\x03\xf8\x42\x01\x42\xbc\x01\n4io.envoyproxy.envoy.extensions.common.async_files.v3B\x15\x41syncFileManagerProtoP\x01Z[github.com/envoyproxy/go-control-plane/envoy/extensions/common/async_files/v3;async_filesv3\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2\xc6\xa4\xe1\x06\x02\x08\x01\x62\x06proto3')



_ASYNCFILEMANAGERCONFIG = DESCRIPTOR.message_types_by_name['AsyncFileManagerConfig']
_ASYNCFILEMANAGERCONFIG_THREADPOOL = _ASYNCFILEMANAGERCONFIG.nested_types_by_name['ThreadPool']
AsyncFileManagerConfig = _reflection.GeneratedProtocolMessageType('AsyncFileManagerConfig', (_message.Message,), {

  'ThreadPool' : _reflection.GeneratedProtocolMessageType('ThreadPool', (_message.Message,), {
    'DESCRIPTOR' : _ASYNCFILEMANAGERCONFIG_THREADPOOL,
    '__module__' : 'envoy.extensions.common.async_files.v3.async_file_manager_pb2'
    # @@protoc_insertion_point(class_scope:envoy.extensions.common.async_files.v3.AsyncFileManagerConfig.ThreadPool)
    })
  ,
  'DESCRIPTOR' : _ASYNCFILEMANAGERCONFIG,
  '__module__' : 'envoy.extensions.common.async_files.v3.async_file_manager_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.common.async_files.v3.AsyncFileManagerConfig)
  })
_sym_db.RegisterMessage(AsyncFileManagerConfig)
_sym_db.RegisterMessage(AsyncFileManagerConfig.ThreadPool)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ASYNCFILEMANAGERCONFIG._serialized_start=197
  _ASYNCFILEMANAGERCONFIG._serialized_end=388
  _ASYNCFILEMANAGERCONFIG_THREADPOOL._serialized_start=333
  _ASYNCFILEMANAGERCONFIG_THREADPOOL._serialized_end=367
