...
_GRAPHITESTATSDSINK = DESCRIPTOR.message_types_by_name['GraphiteStatsdSink']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GRAPHITESTATSDSINK._serialized_start=245
  _GRAPHITESTATSDSINK._serialized_end=427
