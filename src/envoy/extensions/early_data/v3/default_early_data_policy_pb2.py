...
_DEFAULTEARLYDATAPOLICY = DESCRIPTOR.message_types_by_name['DefaultEarlyDataPolicy']
DefaultEarlyDataPolicy = _reflection.GeneratedProtocolMessageType('DefaultEarlyDataPolicy', (_message.Message,), {
  'DESCRIPTOR' : _DEFAULTEARLYDATAPOLICY,
  '__module__' : 'envoy.extensions.early_data.v3.default_early_data_policy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.early_data.v3.DefaultEarlyDataPolicy)
  })
_sym_db.RegisterMessage(DefaultEarlyDataPolicy)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DEFAULTEARLYDATAPOLICY._serialized_start=129
  _DEFAULTEARLYDATAPOLICY._serialized_end=153
