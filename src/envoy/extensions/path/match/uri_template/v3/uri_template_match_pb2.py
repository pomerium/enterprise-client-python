...
_URITEMPLATEMATCHCONFIG = DESCRIPTOR.message_types_by_name['UriTemplateMatchConfig']
UriTemplateMatchConfig = _reflection.GeneratedProtocolMessageType('UriTemplateMatchConfig', (_message.Message,), {
  'DESCRIPTOR' : _URITEMPLATEMATCHCONFIG,
  '__module__' : 'envoy.extensions.path.match.uri_template.v3.uri_template_match_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.path.match.uri_template.v3.UriTemplateMatchConfig)
  })
_sym_db.RegisterMessage(UriTemplateMatchConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _URITEMPLATEMATCHCONFIG._serialized_start=173
  _URITEMPLATEMATCHCONFIG._serialized_end=232
