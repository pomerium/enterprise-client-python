...
_URITEMPLATEREWRITECONFIG = DESCRIPTOR.message_types_by_name['UriTemplateRewriteConfig']
UriTemplateRewriteConfig = _reflection.GeneratedProtocolMessageType('UriTemplateRewriteConfig', (_message.Message,), {
  'DESCRIPTOR' : _URITEMPLATEREWRITECONFIG,
  '__module__' : 'envoy.extensions.path.rewrite.uri_template.v3.uri_template_rewrite_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.path.rewrite.uri_template.v3.UriTemplateRewriteConfig)
  })
_sym_db.RegisterMessage(UriTemplateRewriteConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _URITEMPLATEREWRITECONFIG._serialized_start=179
  _URITEMPLATEREWRITECONFIG._serialized_end=248
