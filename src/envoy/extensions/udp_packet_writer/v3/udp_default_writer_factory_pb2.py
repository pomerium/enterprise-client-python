...
_UDPDEFAULTWRITERFACTORY = DESCRIPTOR.message_types_by_name['UdpDefaultWriterFactory']
UdpDefaultWriterFactory = _reflection.GeneratedProtocolMessageType('UdpDefaultWriterFactory', (_message.Message,), {
  'DESCRIPTOR' : _UDPDEFAULTWRITERFACTORY,
  '__module__' : 'envoy.extensions.udp_packet_writer.v3.udp_default_writer_factory_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.udp_packet_writer.v3.UdpDefaultWriterFactory)
  })
_sym_db.RegisterMessage(UdpDefaultWriterFactory)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _UDPDEFAULTWRITERFACTORY._serialized_start=144
  _UDPDEFAULTWRITERFACTORY._serialized_end=169
