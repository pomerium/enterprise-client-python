...
_KEYVALUESTOREXDSDELEGATECONFIG = DESCRIPTOR.message_types_by_name['KeyValueStoreXdsDelegateConfig']
KeyValueStoreXdsDelegateConfig = _reflection.GeneratedProtocolMessageType('KeyValueStoreXdsDelegateConfig', (_message.Message,), {
  'DESCRIPTOR' : _KEYVALUESTOREXDSDELEGATECONFIG,
  '__module__' : 'contrib.envoy.extensions.config.v3alpha.kv_store_xds_delegate_config_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.config.v3alpha.KeyValueStoreXdsDelegateConfig)
  })
_sym_db.RegisterMessage(KeyValueStoreXdsDelegateConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _KEYVALUESTOREXDSDELEGATECONFIG._serialized_start=189
  _KEYVALUESTOREXDSDELEGATECONFIG._serialized_end=308
