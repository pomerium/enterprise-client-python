...
_HYPERSCAN = DESCRIPTOR.message_types_by_name['Hyperscan']
_HYPERSCAN_REGEX = _HYPERSCAN.nested_types_by_name['Regex']
Hyperscan = _reflection.GeneratedProtocolMessageType('Hyperscan', (_message.Message,), {

  'Regex' : _reflection.GeneratedProtocolMessageType('Regex', (_message.Message,), {
    'DESCRIPTOR' : _HYPERSCAN_REGEX,
    '__module__' : 'contrib.envoy.extensions.matching.input_matchers.hyperscan.v3alpha.hyperscan_pb2'
    # @@protoc_insertion_point(class_scope:envoy.extensions.matching.input_matchers.hyperscan.v3alpha.Hyperscan.Regex)
    })
  ,
  'DESCRIPTOR' : _HYPERSCAN,
  '__module__' : 'contrib.envoy.extensions.matching.input_matchers.hyperscan.v3alpha.hyperscan_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.matching.input_matchers.hyperscan.v3alpha.Hyperscan)
  })
_sym_db.RegisterMessage(Hyperscan)
_sym_db.RegisterMessage(Hyperscan.Regex)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HYPERSCAN._serialized_start=203
  _HYPERSCAN._serialized_end=502
  _HYPERSCAN_REGEX._serialized_start=321
  _HYPERSCAN_REGEX._serialized_end=502
