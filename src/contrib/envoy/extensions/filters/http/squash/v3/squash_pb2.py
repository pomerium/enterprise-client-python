...
_SQUASH = DESCRIPTOR.message_types_by_name['Squash']
Squash = _reflection.GeneratedProtocolMessageType('Squash', (_message.Message,), {
  'DESCRIPTOR' : _SQUASH,
  '__module__' : 'contrib.envoy.extensions.filters.http.squash.v3.squash_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SQUASH._serialized_start=259
  _SQUASH._serialized_end=563
