...
Language = _reflection.GeneratedProtocolMessageType('Language', (_message.Message,), {
  ...
  '__module__' : 'contrib.envoy.extensions.filters.http.language.v3alpha.language_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.http.language.v3alpha.Language)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _LANGUAGE._serialized_start=177
  _LANGUAGE._serialized_end=269
