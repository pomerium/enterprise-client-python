...
Router = _reflection.GeneratedProtocolMessageType('Router', (_message.Message,), {
  'DESCRIPTOR' : _ROUTER,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.router.v3alpha.router_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.router.v3alpha.Router)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ROUTER._serialized_start=172
  _ROUTER._serialized_end=180
