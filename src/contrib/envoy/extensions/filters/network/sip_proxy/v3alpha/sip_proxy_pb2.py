...
_SIPPROXY = DESCRIPTOR.message_types_by_name['SipProxy']
_SIPPROXY_SIPSETTINGS = _SIPPROXY.nested_types_by_name['SipSettings']
_SIPFILTER = DESCRIPTOR.message_types_by_name['SipFilter']
_SIPPROTOCOLOPTIONS = DESCRIPTOR.message_types_by_name['SipProtocolOptions']
_CUSTOMIZEDAFFINITY = DESCRIPTOR.message_types_by_name['CustomizedAffinity']
_CUSTOMIZEDAFFINITYENTRY = DESCRIPTOR.message_types_by_name['CustomizedAffinityEntry']
_CACHE = DESCRIPTOR.message_types_by_name['Cache']
_LOCALSERVICE = DESCRIPTOR.message_types_by_name['LocalService']
SipProxy = _reflection.GeneratedProtocolMessageType('SipProxy', (_message.Message,), {

  'SipSettings' : _reflection.GeneratedProtocolMessageType('SipSettings', (_message.Message,), {
    'DESCRIPTOR' : _SIPPROXY_SIPSETTINGS,
    '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
    # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.SipProxy.SipSettings)
    })
  ,
  'DESCRIPTOR' : _SIPPROXY,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.SipProxy)
  })
_sym_db.RegisterMessage(SipProxy)
_sym_db.RegisterMessage(SipProxy.SipSettings)

SipFilter = _reflection.GeneratedProtocolMessageType('SipFilter', (_message.Message,), {
  'DESCRIPTOR' : _SIPFILTER,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.SipFilter)
  })
_sym_db.RegisterMessage(SipFilter)

SipProtocolOptions = _reflection.GeneratedProtocolMessageType('SipProtocolOptions', (_message.Message,), {
  'DESCRIPTOR' : _SIPPROTOCOLOPTIONS,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.SipProtocolOptions)
  })
_sym_db.RegisterMessage(SipProtocolOptions)

CustomizedAffinity = _reflection.GeneratedProtocolMessageType('CustomizedAffinity', (_message.Message,), {
  'DESCRIPTOR' : _CUSTOMIZEDAFFINITY,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.CustomizedAffinity)
  })
_sym_db.RegisterMessage(CustomizedAffinity)

CustomizedAffinityEntry = _reflection.GeneratedProtocolMessageType('CustomizedAffinityEntry', (_message.Message,), {
  'DESCRIPTOR' : _CUSTOMIZEDAFFINITYENTRY,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.CustomizedAffinityEntry)
  })
_sym_db.RegisterMessage(CustomizedAffinityEntry)

Cache = _reflection.GeneratedProtocolMessageType('Cache', (_message.Message,), {
  'DESCRIPTOR' : _CACHE,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.Cache)
  })
_sym_db.RegisterMessage(Cache)

LocalService = _reflection.GeneratedProtocolMessageType('LocalService', (_message.Message,), {
  'DESCRIPTOR' : _LOCALSERVICE,
  '__module__' : 'contrib.envoy.extensions.filters.network.sip_proxy.v3alpha.sip_proxy_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.sip_proxy.v3alpha.LocalService)
  })
_sym_db.RegisterMessage(LocalService)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SIPPROXY._serialized_start=392
  _SIPPROXY._serialized_end=987
  _SIPPROXY_SIPSETTINGS._serialized_start=705
  _SIPPROXY_SIPSETTINGS._serialized_end=987
  _SIPFILTER._serialized_start=989
  _SIPFILTER._serialized_end=1084
  _SIPPROTOCOLOPTIONS._serialized_start=1087
  _SIPPROTOCOLOPTIONS._serialized_end=1265
  _CUSTOMIZEDAFFINITY._serialized_start=1268
  _CUSTOMIZEDAFFINITY._serialized_end=1409
  _CUSTOMIZEDAFFINITYENTRY._serialized_start=1412
  _CUSTOMIZEDAFFINITYENTRY._serialized_end=1579
  _CACHE._serialized_start=1581
  _CACHE._serialized_end=1640
  _LOCALSERVICE._serialized_start=1642
  _LOCALSERVICE._serialized_end=1691
