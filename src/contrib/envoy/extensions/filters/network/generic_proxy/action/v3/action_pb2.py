...
RouteAction = _reflection.GeneratedProtocolMessageType('RouteAction', (_message.Message,), {
  ...
  'PerFilterConfigEntry' : _reflection.GeneratedProtocolMessageType('PerFilterConfigEntry', (_message.Message,), {
    'DESCRIPTOR' : _ROUTEACTION_PERFILTERCONFIGENTRY,
    '__module__' : 'contrib.envoy.extensions.filters.network.generic_proxy.action.v3.action_pb2'
    # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.generic_proxy.action.v3.RouteAction.PerFilterConfigEntry)
    })
  ,
  'DESCRIPTOR' : _ROUTEACTION,
  '__module__' : 'contrib.envoy.extensions.filters.network.generic_proxy.action.v3.action_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.generic_proxy.action.v3.RouteAction)
  })
_sym_db.RegisterMessage(RouteAction)
_sym_db.RegisterMessage(RouteAction.PerFilterConfigEntry)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ROUTEACTION._serialized_start=335
  _ROUTEACTION._serialized_end=709
  _ROUTEACTION_PERFILTERCONFIGENTRY._serialized_start=607
  _ROUTEACTION_PERFILTERCONFIGENTRY._serialized_end=683
