...
_DUBBOCODECCONFIG = DESCRIPTOR.message_types_by_name['DubboCodecConfig']
DubboCodecConfig = _reflection.GeneratedProtocolMessageType('DubboCodecConfig', (_message.Message,), {
  'DESCRIPTOR' : _DUBBOCODECCONFIG,
  '__module__' : 'contrib.envoy.extensions.filters.network.generic_proxy.codecs.dubbo.v3.dubbo_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.filters.network.generic_proxy.codecs.dubbo.v3.DubboCodecConfig)
  })
_sym_db.RegisterMessage(DubboCodecConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _DUBBOCODECCONFIG._serialized_start=214
  _DUBBOCODECCONFIG._serialized_end=232
