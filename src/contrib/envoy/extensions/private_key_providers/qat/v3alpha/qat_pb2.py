...
_QATPRIVATEKEYMETHODCONFIG = DESCRIPTOR.message_types_by_name['QatPrivateKeyMethodConfig']
QatPrivateKeyMethodConfig = _reflection.GeneratedProtocolMessageType('QatPrivateKeyMethodConfig', (_message.Message,), {
  'DESCRIPTOR' : _QATPRIVATEKEYMETHODCONFIG,
  '__module__' : 'contrib.envoy.extensions.private_key_providers.qat.v3alpha.qat_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig)
  })
_sym_db.RegisterMessage(QatPrivateKeyMethodConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _QATPRIVATEKEYMETHODCONFIG._serialized_start=280
  _QATPRIVATEKEYMETHODCONFIG._serialized_end=433
