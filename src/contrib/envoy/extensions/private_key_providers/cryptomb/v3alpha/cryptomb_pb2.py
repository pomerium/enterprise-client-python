...
_CRYPTOMBPRIVATEKEYMETHODCONFIG = DESCRIPTOR.message_types_by_name['CryptoMbPrivateKeyMethodConfig']
CryptoMbPrivateKeyMethodConfig = _reflection.GeneratedProtocolMessageType('CryptoMbPrivateKeyMethodConfig', (_message.Message,), {
  'DESCRIPTOR' : _CRYPTOMBPRIVATEKEYMETHODCONFIG,
  '__module__' : 'contrib.envoy.extensions.private_key_providers.cryptomb.v3alpha.cryptomb_pb2'
  # @@protoc_insertion_point(class_scope:envoy.extensions.private_key_providers.cryptomb.v3alpha.CryptoMbPrivateKeyMethodConfig)
  })
_sym_db.RegisterMessage(CryptoMbPrivateKeyMethodConfig)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CRYPTOMBPRIVATEKEYMETHODCONFIG._serialized_start=295
  _CRYPTOMBPRIVATEKEYMETHODCONFIG._serialized_end=453
