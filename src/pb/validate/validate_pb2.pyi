...
class _KnownRegexEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_KnownRegex.V], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor = ...
    UNKNOWN = KnownRegex.V(0)
    HTTP_HEADER_NAME = KnownRegex.V(1)
    """HTTP header name as defined by RFC 7230."""

    HTTP_HEADER_VALUE = KnownRegex.V(2)
...
class FloatRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"const",b"const",u"gt",b"gt",u"gte",b"gte",u"ignore_empty",b"ignore_empty",u"lt",b"lt",u"lte",b"lte"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"const",b"const",u"gt",b"gt",u"gte",b"gte",u"ignore_empty",b"ignore_empty",u"in",b"in",u"lt",b"lt",u"lte",b"lte",u"not_in",b"not_in"]) -> None: ...
...
class BoolRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"const",b"const"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"const",b"const"]) -> None: ...
...
class StringRules(google.protobuf.message.Message):
    ...
    well_known_regex: global___KnownRegex.V = ...
...
class BytesRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"const",b"const",u"contains",b"contains",u"ignore_empty",b"ignore_empty",u"ip",b"ip",u"ipv4",b"ipv4",u"ipv6",b"ipv6",u"len",b"len",u"max_len",b"max_len",u"min_len",b"min_len",u"pattern",b"pattern",u"prefix",b"prefix",u"suffix",b"suffix",u"well_known",b"well_known"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"const",b"const",u"contains",b"contains",u"ignore_empty",b"ignore_empty",u"in",b"in",u"ip",b"ip",u"ipv4",b"ipv4",u"ipv6",b"ipv6",u"len",b"len",u"max_len",b"max_len",u"min_len",b"min_len",u"not_in",b"not_in",u"pattern",b"pattern",u"prefix",b"prefix",u"suffix",b"suffix",u"well_known",b"well_known"]) -> None: ...
...
class EnumRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"const",b"const",u"defined_only",b"defined_only"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"const",b"const",u"defined_only",b"defined_only",u"in",b"in",u"not_in",b"not_in"]) -> None: ...
...
class MessageRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"required",b"required",u"skip",b"skip"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"required",b"required",u"skip",b"skip"]) -> None: ...
...
class RepeatedRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"ignore_empty",b"ignore_empty",u"items",b"items",u"max_items",b"max_items",u"min_items",b"min_items",u"unique",b"unique"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"ignore_empty",b"ignore_empty",u"items",b"items",u"max_items",b"max_items",u"min_items",b"min_items",u"unique",b"unique"]) -> None: ...
...
class MapRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"ignore_empty",b"ignore_empty",u"keys",b"keys",u"max_pairs",b"max_pairs",u"min_pairs",b"min_pairs",u"no_sparse",b"no_sparse",u"values",b"values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"ignore_empty",b"ignore_empty",u"keys",b"keys",u"max_pairs",b"max_pairs",u"min_pairs",b"min_pairs",u"no_sparse",b"no_sparse",u"values",b"values"]) -> None: ...
...
class AnyRules(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"in",b"in",u"not_in",b"not_in",u"required",b"required"]) -> None: ...
...
class DurationRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"const",b"const",u"gt",b"gt",u"gte",b"gte",u"lt",b"lt",u"lte",b"lte",u"required",b"required"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"const",b"const",u"gt",b"gt",u"gte",b"gte",u"in",b"in",u"lt",b"lt",u"lte",b"lte",u"not_in",b"not_in",u"required",b"required"]) -> None: ...
...
class TimestampRules(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"const",b"const",u"gt",b"gt",u"gt_now",b"gt_now",u"gte",b"gte",u"lt",b"lt",u"lt_now",b"lt_now",u"lte",b"lte",u"required",b"required",u"within",b"within"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"const",b"const",u"gt",b"gt",u"gt_now",b"gt_now",u"gte",b"gte",u"lt",b"lt",u"lt_now",b"lt_now",u"lte",b"lte",u"required",b"required",u"within",b"within"]) -> None: ...
