...
class NamespacePermissionServiceServicer(metaclass=abc.ABCMeta):
    """NamespacePermissionService manages permissions set on namespaces"""
    @abc.abstractmethod
    def DeleteNamespacePermission(self,
    ...
    @abc.abstractmethod
    def GetNamespacePermission(self,
    ...
    @abc.abstractmethod
    def ListNamespacePermissions(self,
    ...
    @abc.abstractmethod
    def ListNamespacePermissionGroups(self,
    ...
    @abc.abstractmethod
    def ListNamespacePermissionUsers(self,
    ...
    @abc.abstractmethod
    def SetNamespacePermission(self,
