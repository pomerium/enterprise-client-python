...
"""
import builtins
import envoy.type.metadata.v2.metadata_pb2
...
class CustomTag(google.protobuf.message.Message):
    ...
    class Metadata(google.protobuf.message.Message):
        ...
        DEFAULT_VALUE_FIELD_NUMBER: builtins.int
        @property
        def kind(self) -> envoy.type.metadata.v2.metadata_pb2.MetadataKind:
            """Specify what kind of metadata to obtain tag value from."""
            pass
        @property
        def metadata_key(self) -> envoy.type.metadata.v2.metadata_pb2.MetadataKey:
        ...
        def __init__(self,
            *,
            kind : typing.Optional[envoy.type.metadata.v2.metadata_pb2.MetadataKind] = ...,
            metadata_key : typing.Optional[envoy.type.metadata.v2.metadata_pb2.MetadataKey] = ...,
            default_value : typing.Text = ...,
            ) -> None: ...
