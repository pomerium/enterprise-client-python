...
class NodeMatcher(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        node_id : typing.Optional[envoy.type.matcher.v3.string_pb2.StringMatcher] = ...,
        node_metadatas : typing.Optional[typing.Iterable[envoy.type.matcher.v3.struct_pb2.StructMatcher]] = ...,
        ) -> None: ...
