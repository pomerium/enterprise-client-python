...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='envoy/type/matcher/v4alpha/number.proto',
  package='envoy.type.matcher.v4alpha',
  syntax='proto3',
  serialized_options=b'\n(io.envoyproxy.envoy.type.matcher.v4alphaB\013NumberProtoP\001\272\200\310\321\006\002\020\003',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\'envoy/type/matcher/v4alpha/number.proto\x12\x1a\x65nvoy.type.matcher.v4alpha\x1a\x19\x65nvoy/type/v3/range.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\x8f\x01\n\rDoubleMatcher\x12+\n\x05range\x18\x01 \x01(\x0b\x32\x1a.envoy.type.v3.DoubleRangeH\x00\x12\x0f\n\x05\x65xact\x18\x02 \x01(\x01H\x00:*\x9a\xc5\x88\x1e%\n#envoy.type.matcher.v3.DoubleMatcherB\x14\n\rmatch_pattern\x12\x03\xf8\x42\x01\x42\x41\n(io.envoyproxy.envoy.type.matcher.v4alphaB\x0bNumberProtoP\x01\xba\x80\xc8\xd1\x06\x02\x10\x03\x62\x06proto3'
  ,
...
_DOUBLEMATCHER = _descriptor.Descriptor(
  name='DoubleMatcher',
  full_name='envoy.type.matcher.v4alpha.DoubleMatcher',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='range', full_name='envoy.type.matcher.v4alpha.DoubleMatcher.range', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='exact', full_name='envoy.type.matcher.v4alpha.DoubleMatcher.exact', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='match_pattern', full_name='envoy.type.matcher.v4alpha.DoubleMatcher.match_pattern',
...
DoubleMatcher = _reflection.GeneratedProtocolMessageType('DoubleMatcher', (_message.Message,), {
  ...
  '__module__' : 'envoy.type.matcher.v4alpha.number_pb2'
  # @@protoc_insertion_point(class_scope:envoy.type.matcher.v4alpha.DoubleMatcher)
  })
