...
_TYPEDEXTENSIONCONFIG = DESCRIPTOR.message_types_by_name['TypedExtensionConfig']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TYPEDEXTENSIONCONFIG._serialized_start=96
  _TYPEDEXTENSIONCONFIG._serialized_end=195
