...
_SERVERNAMEMATCHER = DESCRIPTOR.message_types_by_name['ServerNameMatcher']
_SERVERNAMEMATCHER_DOMAINMATCHER = _SERVERNAMEMATCHER.nested_types_by_name['DomainMatcher']
ServerNameMatcher = _reflection.GeneratedProtocolMessageType('ServerNameMatcher', (_message.Message,), {

  'DomainMatcher' : _reflection.GeneratedProtocolMessageType('DomainMatcher', (_message.Message,), {
    'DESCRIPTOR' : _SERVERNAMEMATCHER_DOMAINMATCHER,
    '__module__' : 'xds.type.matcher.v3.domain_pb2'
    # @@protoc_insertion_point(class_scope:xds.type.matcher.v3.ServerNameMatcher.DomainMatcher)
    })
  ,
  'DESCRIPTOR' : _SERVERNAMEMATCHER,
  '__module__' : 'xds.type.matcher.v3.domain_pb2'
  # @@protoc_insertion_point(class_scope:xds.type.matcher.v3.ServerNameMatcher)
  })
_sym_db.RegisterMessage(ServerNameMatcher)
_sym_db.RegisterMessage(ServerNameMatcher.DomainMatcher)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SERVERNAMEMATCHER._serialized_start=151
  _SERVERNAMEMATCHER._serialized_end=349
  _SERVERNAMEMATCHER_DOMAINMATCHER._serialized_start=251
  _SERVERNAMEMATCHER_DOMAINMATCHER._serialized_end=349
