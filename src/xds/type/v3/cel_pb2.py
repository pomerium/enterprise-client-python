...
_CELEXPRESSION = DESCRIPTOR.message_types_by_name['CelExpression']
_CELEXTRACTSTRING = DESCRIPTOR.message_types_by_name['CelExtractString']
CelExpression = _reflection.GeneratedProtocolMessageType('CelExpression', (_message.Message,), {
  'DESCRIPTOR' : _CELEXPRESSION,
  '__module__' : 'xds.type.v3.cel_pb2'
  # @@protoc_insertion_point(class_scope:xds.type.v3.CelExpression)
  })
_sym_db.RegisterMessage(CelExpression)

CelExtractString = _reflection.GeneratedProtocolMessageType('CelExtractString', (_message.Message,), {
  'DESCRIPTOR' : _CELEXTRACTSTRING,
  '__module__' : 'xds.type.v3.cel_pb2'
  # @@protoc_insertion_point(class_scope:xds.type.v3.CelExtractString)
  })
_sym_db.RegisterMessage(CelExtractString)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CELEXPRESSION._serialized_start=208
  _CELEXPRESSION._serialized_end=370
  _CELEXTRACTSTRING._serialized_start=373
  _CELEXTRACTSTRING._serialized_end=504
