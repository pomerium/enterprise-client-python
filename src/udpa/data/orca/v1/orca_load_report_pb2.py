...
OrcaLoadReport = _reflection.GeneratedProtocolMessageType('OrcaLoadReport', (_message.Message,), {
  ...
  'RequestCostEntry' : _reflection.GeneratedProtocolMessageType('RequestCostEntry', (_message.Message,), {
    ...
    '__module__' : 'udpa.data.orca.v1.orca_load_report_pb2'
    # @@protoc_insertion_point(class_scope:udpa.data.orca.v1.OrcaLoadReport.RequestCostEntry)
    })
  ,
  ...
  'UtilizationEntry' : _reflection.GeneratedProtocolMessageType('UtilizationEntry', (_message.Message,), {
    ...
    '__module__' : 'udpa.data.orca.v1.orca_load_report_pb2'
    # @@protoc_insertion_point(class_scope:udpa.data.orca.v1.OrcaLoadReport.UtilizationEntry)
    })
  ,
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ORCALOADREPORT._serialized_start=89
  _ORCALOADREPORT._serialized_end=519
  _ORCALOADREPORT_REQUESTCOSTENTRY._serialized_start=417
  _ORCALOADREPORT_REQUESTCOSTENTRY._serialized_end=467
  _ORCALOADREPORT_UTILIZATIONENTRY._serialized_start=469
  _ORCALOADREPORT_UTILIZATIONENTRY._serialized_end=519
