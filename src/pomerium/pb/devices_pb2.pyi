...
class _DeviceKindEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeviceKind.ValueType], builtins.type):
...
class WebAuthnOptions(google.protobuf.message.Message):
    ...
    class _AttestationConveyancePreferenceEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[WebAuthnOptions._AttestationConveyancePreference.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _AuthenticatorAttachmentEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[WebAuthnOptions._AuthenticatorAttachment.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _PublicKeyCredentialTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[WebAuthnOptions._PublicKeyCredentialType.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _ResidentKeyRequirementEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[WebAuthnOptions._ResidentKeyRequirement.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class _UserVerificationRequirementEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[WebAuthnOptions._UserVerificationRequirement.ValueType], builtins.type):
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    class AuthenticatorSelectionCriteria(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["_authenticator_attachment", b"_authenticator_attachment", "_require_resident_key", b"_require_resident_key", "_resident_key_requirement", b"_resident_key_requirement", "_user_verification", b"_user_verification", "authenticator_attachment", b"authenticator_attachment", "require_resident_key", b"require_resident_key", "resident_key_requirement", b"resident_key_requirement", "user_verification", b"user_verification"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["_authenticator_attachment", b"_authenticator_attachment", "_require_resident_key", b"_require_resident_key", "_resident_key_requirement", b"_resident_key_requirement", "_user_verification", b"_user_verification", "authenticator_attachment", b"authenticator_attachment", "require_resident_key", b"require_resident_key", "resident_key_requirement", b"resident_key_requirement", "user_verification", b"user_verification"]) -> None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_authenticator_attachment", b"_authenticator_attachment"]) -> typing.Literal["authenticator_attachment"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_require_resident_key", b"_require_resident_key"]) -> typing.Literal["require_resident_key"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_resident_key_requirement", b"_resident_key_requirement"]) -> typing.Literal["resident_key_requirement"] | None: ...
        @typing.overload
        def WhichOneof(self, oneof_group: typing.Literal["_user_verification", b"_user_verification"]) -> typing.Literal["user_verification"] | None: ...
    ...
    def HasField(self, field_name: typing.Literal["_attestation", b"_attestation", "_authenticator_selection", b"_authenticator_selection", "attestation", b"attestation", "authenticator_selection", b"authenticator_selection"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_attestation", b"_attestation", "_authenticator_selection", b"_authenticator_selection", "attestation", b"attestation", "authenticator_selection", b"authenticator_selection", "pub_key_cred_params", b"pub_key_cred_params"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_attestation", b"_attestation"]) -> typing.Literal["attestation"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_authenticator_selection", b"_authenticator_selection"]) -> typing.Literal["authenticator_selection"] | None: ...
...
class DeviceType(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["created_at", b"created_at", "deleted_at", b"deleted_at", "modified_at", b"modified_at", "specifier", b"specifier", "webauthn", b"webauthn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["created_at", b"created_at", "deleted_at", b"deleted_at", "id", b"id", "modified_at", b"modified_at", "name", b"name", "specifier", b"specifier", "webauthn", b"webauthn"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["specifier", b"specifier"]) -> typing.Literal["webauthn"] | None: ...
...
class DeviceEnrollment(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_cluster_id", b"_cluster_id", "approved_at", b"approved_at", "cluster_id", b"cluster_id", "created_at", b"created_at", "deleted_at", b"deleted_at", "enrolled_at", b"enrolled_at", "modified_at", b"modified_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_cluster_id", b"_cluster_id", "approved_at", b"approved_at", "approved_by_user_id", b"approved_by_user_id", "cluster_id", b"cluster_id", "created_at", b"created_at", "deleted_at", b"deleted_at", "device_credential_id", b"device_credential_id", "device_type_id", b"device_type_id", "enrolled_at", b"enrolled_at", "id", b"id", "ip_address", b"ip_address", "modified_at", b"modified_at", "user_agent", b"user_agent", "user_id", b"user_id"]) -> None: ...
...
class DeviceCredential(google.protobuf.message.Message):
    ...
    class WebAuthn(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["authenticate_response", b"authenticate_response", "id", b"id", "public_key", b"public_key", "register_options", b"register_options", "register_response", b"register_response"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["_cluster_id", b"_cluster_id", "cluster_id", b"cluster_id", "created_at", b"created_at", "deleted_at", b"deleted_at", "modified_at", b"modified_at", "specifier", b"specifier", "webauthn", b"webauthn"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_cluster_id", b"_cluster_id", "cluster_id", b"cluster_id", "created_at", b"created_at", "deleted_at", b"deleted_at", "device_enrollment_id", b"device_enrollment_id", "device_type_id", b"device_type_id", "id", b"id", "modified_at", b"modified_at", "specifier", b"specifier", "user_id", b"user_id", "webauthn", b"webauthn"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_cluster_id", b"_cluster_id"]) -> typing.Literal["cluster_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["specifier", b"specifier"]) -> typing.Literal["webauthn"] | None: ...
...
class DeviceOwnerCredentialRecord(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["id", b"id", "owner_id", b"owner_id", "public_key", b"public_key"]) -> None: ...
...
class ApproveDeviceRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["credential_id", b"credential_id", "enrollment_id", b"enrollment_id", "id", b"id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["credential_id", b"credential_id", "enrollment_id", b"enrollment_id", "id", b"id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["id", b"id"]) -> typing.Literal["credential_id", "enrollment_id"] | None: ...
...
class CreateDeviceEnrollmentRequest(google.protobuf.message.Message):
    ...
    ROUTE_URL_FIELD_NUMBER: builtins.int
    REDIRECT_URL_FIELD_NUMBER: builtins.int
    route_url: builtins.str
    ...
    def HasField(self, field_name: typing.Literal["enrollment", b"enrollment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["enrollment", b"enrollment", "redirect_url", b"redirect_url", "route_url", b"route_url"]) -> None: ...
...
class CreateDeviceEnrollmentResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["enrollment", b"enrollment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["enrollment", b"enrollment", "enrollment_url", b"enrollment_url"]) -> None: ...
...
class ListDevicesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_approved_by", b"_approved_by", "_cluster_id", b"_cluster_id", "_type_id", b"_type_id", "_user_id", b"_user_id", "approved_by", b"approved_by", "cluster_id", b"cluster_id", "type_id", b"type_id", "user_id", b"user_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_approved_by", b"_approved_by", "_cluster_id", b"_cluster_id", "_type_id", b"_type_id", "_user_id", b"_user_id", "approved_by", b"approved_by", "cluster_id", b"cluster_id", "type_id", b"type_id", "user_id", b"user_id"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_approved_by", b"_approved_by"]) -> typing.Literal["approved_by"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_cluster_id", b"_cluster_id"]) -> typing.Literal["cluster_id"] | None: ...
    @typing.overload
...
class ListDevicesResponse(google.protobuf.message.Message):
    ...
    class Device(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["credential", b"credential", "enrollment", b"enrollment", "type", b"type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["approved_by_user_name", b"approved_by_user_name", "credential", b"credential", "enrollment", b"enrollment", "kind", b"kind", "type", b"type", "user_name", b"user_name"]) -> None: ...
...
@typing.final
class ListDeviceTypesRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___ListDeviceTypesRequest = ListDeviceTypesRequest
