...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in external_data_sources_pb2_grpc.py depends on'
...
def add_ExternalDataSourceServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('pomerium.dashboard.ExternalDataSourceService', rpc_method_handlers)
