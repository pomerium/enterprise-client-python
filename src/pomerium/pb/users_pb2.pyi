...
class PomeriumServiceAccount(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal[u"_namespace_id",b"_namespace_id",u"expires_at",b"expires_at",u"issued_at",b"issued_at",u"namespace_id",b"namespace_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal[u"_namespace_id",b"_namespace_id",u"expires_at",b"expires_at",u"id",b"id",u"issued_at",b"issued_at",u"namespace_id",b"namespace_id",u"user_id",b"user_id"]) -> None: ...
