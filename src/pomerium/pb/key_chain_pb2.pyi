...
class _PublicKeyAlgorithmEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PublicKeyAlgorithm.ValueType], builtins.type):
...
class KeyPair(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["certificate", b"certificate", "created_at", b"created_at", "id", b"id", "key", b"key", "modified_at", b"modified_at", "name", b"name", "namespace_id", b"namespace_id", "originator_id", b"originator_id"]) -> None: ...
...
class KeyUsage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["cert_sign", b"cert_sign", "client_auth", b"client_auth", "content_commitment", b"content_commitment", "crl_sign", b"crl_sign", "data_encipherment", b"data_encipherment", "decipher_only", b"decipher_only", "digital_signature", b"digital_signature", "encipher_only", b"encipher_only", "key_agreement", b"key_agreement", "key_encipherment", b"key_encipherment", "server_auth", b"server_auth"]) -> None: ...
...
class Name(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["common_name", b"common_name", "country", b"country", "locality", b"locality", "organization", b"organization", "organizational_unit", b"organizational_unit", "postal_code", b"postal_code", "province", b"province", "serial_number", b"serial_number", "street_address", b"street_address"]) -> None: ...
...
class GetKeyPairResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["key_pair", b"key_pair"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["key_pair", b"key_pair"]) -> None: ...
...
class ListKeyPairsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_cluster_id", b"_cluster_id", "_domain", b"_domain", "_limit", b"_limit", "_offset", b"_offset", "_order_by", b"_order_by", "_query", b"_query", "cluster_id", b"cluster_id", "domain", b"domain", "limit", b"limit", "offset", b"offset", "order_by", b"order_by", "query", b"query"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_cluster_id", b"_cluster_id", "_domain", b"_domain", "_limit", b"_limit", "_offset", b"_offset", "_order_by", b"_order_by", "_query", b"_query", "cluster_id", b"cluster_id", "domain", b"domain", "limit", b"limit", "namespace_id", b"namespace_id", "offset", b"offset", "order_by", b"order_by", "query", b"query"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_cluster_id", b"_cluster_id"]) -> typing.Literal["cluster_id"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_domain", b"_domain"]) -> typing.Literal["domain"] | None: ...
    @typing.overload
...
class ListKeyPairsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["key_pairs", b"key_pairs", "total_count", b"total_count"]) -> None: ...
...
class UpdateKeyPairRequest(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        format: global___Format.ValueType | None = ...,
        certificate: builtins.bytes | None = ...,
        key: builtins.bytes | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_certificate", b"_certificate", "_format", b"_format", "_key", b"_key", "_name", b"_name", "certificate", b"certificate", "format", b"format", "key", b"key", "name", b"name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_certificate", b"_certificate", "_format", b"_format", "_key", b"_key", "_name", b"_name", "certificate", b"certificate", "format", b"format", "id", b"id", "key", b"key", "name", b"name", "originator_id", b"originator_id"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_certificate", b"_certificate"]) -> typing.Literal["certificate"] | None: ...
    @typing.overload
