...
class MCPServer(google.protobuf.message.Message):
    ...
    AUTHORIZATION_SERVER_URL_FIELD_NUMBER: builtins.int
    max_request_bytes: builtins.int
    path: builtins.str
    authorization_server_url: builtins.str
    @property
    ...
    def __init__(
        ...
        *,
        ...
        authorization_server_url: builtins.str | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_authorization_server_url", b"_authorization_server_url", "_max_request_bytes", b"_max_request_bytes", "_path", b"_path", "_upstream_oauth2", b"_upstream_oauth2", "authorization_server_url", b"authorization_server_url", "max_request_bytes", b"max_request_bytes", "path", b"path", "upstream_oauth2", b"upstream_oauth2"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_authorization_server_url", b"_authorization_server_url", "_max_request_bytes", b"_max_request_bytes", "_path", b"_path", "_upstream_oauth2", b"_upstream_oauth2", "authorization_server_url", b"authorization_server_url", "max_request_bytes", b"max_request_bytes", "path", b"path", "upstream_oauth2", b"upstream_oauth2"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_authorization_server_url", b"_authorization_server_url"]) -> typing.Literal["authorization_server_url"] | None: ...
    @typing.overload
...
class Route(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_upstream_tunnel", b"_upstream_tunnel"]) -> typing.Literal["upstream_tunnel"] | None: ...
